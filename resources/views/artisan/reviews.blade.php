                                            ...
                                            <div
                                                ...
                                                @if ($review->customer->avatar)
                                                    <img src="{{ asset('storage/' . $review->customer->avatar) }}"
                                                        alt="{{ $review->customer->name }}" class="h-10 w-10 rounded-full">
                                                @else
                                                    <span
                                                        class="text-gray-500 font-medium">{{ substr($review->customer->firstname, 0, 1) }}{{ substr($review->customer->lastname, 0, 1) }}</span>
                                                @endif
                                            </div>
                                            <div class="ml-4">
