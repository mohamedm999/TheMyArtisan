...
@section('description', 'MyArtisan\'s privacy policy explains how we collect, use, and protect your personal information
...
@section('content')
    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-4xl mx-auto prose prose-amber lg:prose-lg">
            <h2>Introduction</h2>
            <p>
                At MyArtisan, we respect your privacy and are committed to protecting your personal data. This Privacy
            ...
            <p>
                ...
                to distinguish you from other users of our platform. This helps us provide you with a good experience when
                you browse our platform and also allows us to improve our services.
            </p>
            <p>
                You can set your browser to refuse all or some browser cookies, or to alert you when cookies are being sent.
                If you disable or refuse cookies, please note that some parts of the platform may be inaccessible or not
                function properly.
            </p>
            ...
            <p>
                ...
                reside. These countries may have different data protection laws than your country of residence. We will take
