...
class StoreController extends Controller
{
    ...
    {
        $products = StoreProduct::where('is_featured', true)
            ->where('is_available', true)
            ->orderBy('created_at', 'desc')
            ->paginate(16);
        ...
        return view('client.store.featured', compact('products', 'points'));
    }
    ...
    public function orders()
    {
        ...
        return view('client.store.orders', compact('orders', 'user'));
    }
