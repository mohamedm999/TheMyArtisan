...
class StoreProductController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $recentOrders = ProductOrder::where('store_product_id', $product->id)
        ...
        $totalPointsSpent = ProductOrder::where('store_product_id', $product->id)->sum('points_spent');

        return view('admin.store.products.show', compact('product', 'recentOrders', 'orderCount', 'totalPointsSpent'));
    }
    ...
    public function toggleAvailability($id)
    {
        ...
        return redirect()->back()->with('success', "Product has been marked as {$status}.");
    }
