...
<nav class="bg-white/95 backdrop-blur-sm shadow-md border-b border-gray-100/40 sticky top-0 z-30"
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center group">
                        ...
                        <span class="ml-2 text-amber-600 font-bold text-lg hidden md:block transition-all duration-300 group-hover:text-amber-500">
                            MyArtisan
                        </span>
                    </a>
                </div>
                ...
                <div class="hidden sm:ml-8 sm:flex sm:space-x-8">
                    <a href="{{ route('home') }}"
                       class="inline-flex items-center px-1 pt-1 border-b-2 relative group {{ request()->routeIs('home') ? 'border-amber-500 text-amber-700 font-medium' : 'border-transparent text-gray-500 hover:border-amber-300 hover:text-amber-600' }} text-sm">
                        <span class="absolute inset-x-0 bottom-0 h-0 group-hover:h-1 bg-amber-200/50 transition-all duration-200 rounded-t-md {{ request()->routeIs('home') ? 'hidden' : '' }}"></span>
                        Home
                    </a>
                    ...
                    <a href="{{ route('about') }}"
                       class="inline-flex items-center px-1 pt-1 border-b-2 relative group {{ request()->routeIs('about') ? 'border-amber-500 text-amber-700 font-medium' : 'border-transparent text-gray-500 hover:border-amber-300 hover:text-amber-600' }} text-sm">
                        <span class="absolute inset-x-0 bottom-0 h-0 group-hover:h-1 bg-amber-200/50 transition-all duration-200 rounded-t-md {{ request()->routeIs('about') ? 'hidden' : '' }}"></span>
                        About
                    </a>
                    ...
                    <div class="relative inline-block" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false"
                            ...
                            <span class="absolute inset-x-0 bottom-0 h-0 group-hover:h-1 bg-amber-200/50 transition-all duration-200 rounded-t-md {{ request()->routeIs('crafts.*') ? 'hidden' : '' }}"></span>
                            Crafts
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="py-2" role="menu" aria-orientation="vertical">
                                ...
                                <a href="{{ route('crafts.index') }}"
                                   ...
                                   role="menuitem">
                                   <span class="w-1 h-4 mr-2 rounded-full bg-amber-300 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                   All Crafts
                                </a>
                    ...
                    <a href="{{ route('featured-artisans') }}"
                       class="inline-flex items-center px-1 pt-1 border-b-2 relative group {{ request()->routeIs('featured-artisans') ? 'border-amber-500 text-amber-700 font-medium' : 'border-transparent text-gray-500 hover:border-amber-300 hover:text-amber-600' }} text-sm">
                        <span class="absolute inset-x-0 bottom-0 h-0 group-hover:h-1 bg-amber-200/50 transition-all duration-200 rounded-t-md {{ request()->routeIs('featured-artisans') ? 'hidden' : '' }}"></span>
                        Artisans
                    </a>
                    ...
                    <a href="{{ route('blog.index') }}"
                       class="inline-flex items-center px-1 pt-1 border-b-2 relative group {{ request()->routeIs('blog.index') ? 'border-amber-500 text-amber-700 font-medium' : 'border-transparent text-gray-500 hover:border-amber-300 hover:text-amber-600' }} text-sm">
                        <span class="absolute inset-x-0 bottom-0 h-0 group-hover:h-1 bg-amber-200/50 transition-all duration-200 rounded-t-md {{ request()->routeIs('blog.index') ? 'hidden' : '' }}"></span>
                        Blog
                    </a>
                    ...
                    <a href="{{ route('contact') }}"
                       class="inline-flex items-center px-1 pt-1 border-b-2 relative group {{ request()->routeIs('contact') ? 'border-amber-500 text-amber-700 font-medium' : 'border-transparent text-gray-500 hover:border-amber-300 hover:text-amber-600' }} text-sm">
                        <span class="absolute inset-x-0 bottom-0 h-0 group-hover:h-1 bg-amber-200/50 transition-all duration-200 rounded-t-md {{ request()->routeIs('contact') ? 'hidden' : '' }}"></span>
                        Contact
                    </a>
                </div>
            </div>
                ...
                @guest
                    ...
                    <a href="{{ route('register') }}"
                       class="text-sm px-4 py-2 border border-amber-500 rounded-md bg-gradient-to-br from-amber-500 to-amber-600 text-white hover:from-amber-600 hover:to-amber-700 hover:border-amber-600 transition-all duration-300 shadow-sm hover:shadow group">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 inline-block ml-1 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="ml-3 relative" x-data="{ open: false }">
                        <div>
                            <button @click="open = !open" @click.away="open = false"
                                ...
                                <div class="h-9 w-9 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center text-white font-semibold text-sm overflow-hidden shadow-inner border-2 border-white transition-transform duration-500 hover:scale-105 hover:rotate-3">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="py-2">
                                <div class="px-4 py-3 bg-gradient-to-r from-amber-50/50 to-white border-l-2 border-amber-400">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                        ...
                                        <span class="w-5 h-5 flex items-center justify-center mr-2 rounded-full bg-red-100 text-red-500 group-hover:bg-red-200 transition-colors">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <div class="px-4 py-3 bg-gradient-to-r from-amber-50 to-white rounded-lg mx-2 shadow-sm">
                    <div class="flex items-center">
                        <div class="h-12 w-12 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full flex items-center justify-center text-white shadow-inner border-2 border-white">
                            <span class="font-semibold text-base">{{ substr(Auth::user()->firstname, 0, 1) }}{{ substr(Auth::user()->lastname, 0, 1) }}</span>
                        </div>
