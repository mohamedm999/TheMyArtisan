            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="{{ url('/') }}" class="flex items-center group">
                    ...
                    <div class="flex flex-col">
                        <span class="text-xl font-bold text-amber-600 tracking-tight group-hover:text-amber-700 transition-colors">MyArtisan</span>
                        <span class="arabic-font text-sm text-amber-500 group-hover:text-amber-600 transition-colors">المغرب</span>
                    </div>
                </a>
            </div>
                        ...
                        <div>
                            <button @click="open = !open" type="button"
                                ...
                                <span class="flex items-center">
                                    <span class="h-8 w-8 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 mr-2">
                                        {{ substr(Auth::user()->firstname, 0, 1) }}{{ substr(Auth::user()->lastname, 0, 1) }}
                                    </span>
                                    <span class="mr-1 text-sm font-medium group-hover:text-amber-600">{{ Auth::user()->firstname }}
                                        {{ Auth::user()->lastname }}</span>
                                </span>
                                <svg class="h-4 w-4 transition-transform duration-200 group-hover:text-amber-600" :class="{'rotate-180': open}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            ...
                            <div class="py-1">
                                @if (Auth::user()->hasRole('admin'))
                                    <a href="{{ route('admin.dashboard') }}"
                                        ...
                                        role="menuitem">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-amber-500 group-hover:text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
