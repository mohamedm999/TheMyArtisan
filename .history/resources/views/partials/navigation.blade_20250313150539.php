        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="{{ url('/') }}" class="flex items-center group">
                    <!-- Make sure this image exists in the public/images directory -->
                    <img src="{{ asset('images/logoartisan1.png') }}" alt="MyArtisan Logo"
                    ...
                    <div class="flex flex-col">
                        ...
                        <span
                            class="arabic-font text-sm text-amber-500 group-hover:text-amber-600 transition-colors">حرفيين
                            المغرب</span>
                    </div>
                </a>
            </div>
