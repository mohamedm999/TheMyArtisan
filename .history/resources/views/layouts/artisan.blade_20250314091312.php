                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="{{ route('artisan.dashboard') }}" class="flex items-center space-x-2">
                            ...
                            <span class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-amber-200">MyArtisan Workspace</span>
                        </a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ notificationsOpen: false }">
                            <button @click="notificationsOpen = !notificationsOpen" class="p-1 rounded-full text-white hover:bg-amber-600 focus:outline-none">
                            ...
                            <div x-show="notificationsOpen" @click.away="notificationsOpen = false" 
                                ...
                                <div class="py-1">
                                    <a href="#" class="block px-4 py-2 text-sm text-amber-600 hover:bg-gray-100 rounded-md text-center">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-3 text-white focus:outline-none hover:bg-amber-600 p-2 rounded-lg transition-colors duration-200">
                                <div class="w-8 h-8 rounded-full bg-amber-500 flex items-center justify-center border-2 border-white">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <div class="py-1">
                                    <a href="{{ route('artisan.profile') }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-amber-50">
                                        <i class="fas fa-user mr-3 text-amber-600"></i> My Profile
                                    </a>
                                    <a href="{{ route('artisan.settings') }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-amber-50">
                                ...
                                <div class="py-1">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="group flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-amber-50">
