...
<body class="bg-gray-50 font-sans antialiased">
    <div class="min-h-screen flex flex-col">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center md:hidden">
                        <button type="button" x-data
                            @click="document.querySelector('body').classList.toggle('sidebar-open')"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative" x-data="{ open: false }" x-cloak>
                            <button @click="open = !open"
                                class="p-1 rounded-full text-gray-500 hover:text-primary-600 hover:bg-gray-100 focus:outline-none">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                <div class="border-t border-gray-100 px-4 py-2">
                                    <a href="#"
                                        class="text-xs font-medium text-primary-600 hover:text-primary-800">View all
                                        notifications</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative" x-data="{ open: false }" x-cloak>
                            <button @click="open = !open"
                                class="flex items-center gap-2 text-gray-700 hover:text-primary-600 focus:outline-none">
                                <div
                                    class="h-8 w-8 rounded-full bg-primary-100 flex items-center justify-center text-primary-700">
                                    <span
                                        class="text-sm font-medium">{{ substr(Auth::user()->firstname, 0, 1) }}{{ substr(Auth::user()->lastname, 0, 1) }}</span>
                                </div>
                                <span class="hidden md:block text-sm font-medium">{{ Auth::user()->firstname }}
        ...
        <div class="flex flex-grow">
            <!-- Sidebar -->
            <div
                class="fixed inset-y-0 left-0 z-20 transform md:translate-x-0 -translate-x-full transition duration-300 ease-in-out md:relative md:flex md:flex-col md:justify-between md:w-64 h-full bg-white border-r border-gray-200 shadow-sm overflow-y-auto sidebar">
                    ...
                    <div class="p-4 md:pt-8">
                        ...
                        <div class="space-y-0.5">
                            <a href="{{ route('admin.dashboard') }}"
                                ...
                                <i
                                    class="fas fa-tachometer-alt w-5 mr-3 {{ request()->routeIs('admin.dashboard') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Dashboard</span>
                            </a>
                            ...
                            <a href="{{ route('admin.users.index') }}"
                                ...
                                <i
                                    class="fas fa-users w-5 mr-3 {{ request()->routeIs('admin.users.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Users</span>
                            </a>
                            ...
                            <a href="{{ route('admin.artisans.index') }}"
                                ...
                                <i
                                    class="fas fa-hammer w-5 mr-3 {{ request()->routeIs('admin.artisans.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Artisans</span>
                            </a>
                            ...
                            <a href="{{ route('admin.categories.index') }}"
                                ...
                                <i
                                    class="fas fa-tags w-5 mr-3 {{ request()->routeIs('admin.categories.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                            ...
                            <a href="{{ route('admin.services.index') }}"
                                ...
                                <i
                                    class="fas fa-briefcase w-5 mr-3 {{ request()->routeIs('admin.services.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Services</span>
                            </a>
                            ...
                            <a href="{{ route('admin.bookings.index') }}"
                                ...
                                <i
                                    class="fas fa-calendar w-5 mr-3 {{ request()->routeIs('admin.bookings.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Bookings</span>
                            </a>
                            ...
                            <a href="{{ route('admin.reviews.index') }}"
                                ...
                                <i
                                    class="fas fa-star w-5 mr-3 {{ request()->routeIs('admin.reviews.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Reviews</span>
                            </a>

                            <a href="{{ route('admin.store.products.index') }}"
                                class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg group transition-all duration-200 {{ request()->routeIs('admin.store.products.*') ? 'text-primary-700 bg-primary-50' : 'text-gray-700 hover:text-primary-700 hover:bg-gray-100' }}">
                                <i
                                    class="fas fa-box w-5 mr-3 {{ request()->routeIs('admin.store.products.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Products</span>
                            </a>
                            ...
                            <a href="{{ route('admin.points.index') }}"
                                ...
                                <i
                                    class="fas fa-coins w-5 mr-3 {{ request()->routeIs('admin.points.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                            ...
                            <a href="{{ route('admin.certifications.index') }}"
                                ...
                                <i
                                    class="fas fa-certificate w-5 mr-3 {{ request()->routeIs('admin.certifications.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                            ...
                            <a href="{{ route('admin.settings.index') }}"
                                ...
                                <i
                                    class="fas fa-cog w-5 mr-3 {{ request()->routeIs('admin.settings.*') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }}"></i>
                                <span>Settings</span>
                            </a>
                        </div>
                    </div>
