                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="{{ route('client.dashboard') }}" class="flex items-center space-x-2">
                            ...
                            <span class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-green-200">MyArtisan Client</span>
                        </a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ notificationsOpen: false }">
                            <button @click="notificationsOpen = !notificationsOpen" class="p-1 rounded-full text-white hover:bg-green-600 focus:outline-none">
                            ...
                            <div x-show="notificationsOpen" @click.away="notificationsOpen = false"
                                ...
                                <div class="py-1">
                                    <a href="#" class="block px-4 py-2 text-sm text-green-600 hover:bg-gray-100 rounded-md text-center">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-3 text-white focus:outline-none hover:bg-green-600 p-2 rounded-lg transition-colors duration-200">
                                <div class="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center border-2 border-white">
                                    <span class="text-xs font-bold">{{ substr(Auth::user()->firstname, 0, 1) }}{{ substr(Auth::user()->lastname, 0, 1) }}</span>
                                </div>
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <div class="py-1">
                                    <a href="{{ route('client.profile') }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-green-50">
                                        <i class="fas fa-user mr-3 text-green-600"></i> My Profile
                                    </a>
                                    <a href="{{ route('client.settings') }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-green-50">
                                ...
                                <div class="py-1">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="group flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-green-50">
            ...
            <div class="hidden md:block w-64 bg-white shadow-md">
                <div class="flex flex-col h-full">
                    <div class="p-4 border-b border-gray-200">
                        ...
                        <h5 class="text-center font-medium">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</h5>
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="{{ route('client.dashboard') }}"
                                    ...
                                    <i class="fas fa-tachometer-alt w-6 {{ request()->routeIs('client.dashboard') ? 'text-green-600' : 'text-gray-500' }}"></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('client.profile') }}"
                                    ...
                                    <i class="fas fa-user w-6 {{ request()->routeIs('client.profile') ? 'text-green-600' : 'text-gray-500' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('client.find-artisans') }}"
                                    ...
                                    <i class="fas fa-search w-6 {{ request()->routeIs('client.find-artisans') ? 'text-green-600' : 'text-gray-500' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('client.bookings') }}"
                                    ...
                                    <i class="fas fa-calendar w-6 {{ request()->routeIs('client.bookings') ? 'text-green-600' : 'text-gray-500' }}"></i>
                                    <span>My Bookings</span>
                                    <span class="ml-auto bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded">3</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('client.saved-artisans') }}"
                                    ...
                                    <i class="fas fa-heart w-6 {{ request()->routeIs('client.saved-artisans') ? 'text-green-600' : 'text-gray-500' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('client.messages') }}"
                                    ...
                                    <i class="fas fa-comments w-6 {{ request()->routeIs('client.messages') ? 'text-green-600' : 'text-gray-500' }}"></i>
                                    <span>Messages</span>
                            ...
                            <li>
                                <a href="{{ route('client.settings') }}"
                                    ...
                                    <i class="fas fa-cog w-6 {{ request()->routeIs('client.settings') ? 'text-green-600' : 'text-gray-500' }}"></i>
                                    <span>Settings</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="mt-auto p-4 border-t border-gray-200">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="flex w-full items-center p-2 text-gray-700 rounded-lg hover:bg-red-50 transition-colors duration-200">
