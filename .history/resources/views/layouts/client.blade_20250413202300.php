                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="{{ route('client.artisans.index') }}"
                                    class="flex items-center p-2 text-gray-700 rounded-lg hover:bg-green-50 transition-colors duration-200 {{ request()->routeIs('client.artisans.index') ? 'bg-green-50 text-green-700 font-medium' : '' }}">
                                    <i
                                        class="fas fa-search w-6 {{ request()->routeIs('client.artisans.index') ? 'text-green-600' : 'text-gray-500' }}"></i>
                            ...
                            <li>
                                <a href="{{ route('client.points.index') }}"
                                    class="flex items-center p-2 text-gray-700 rounded-lg hover:bg-green-50 transition-colors duration-200 {{ request()->routeIs('client.points.*') ? 'bg-green-50 text-green-700 font-medium' : '' }}">
                                    <i
                                        class="fas fa-coins w-6 {{ request()->routeIs('client.points.*') ? 'text-green-600' : 'text-gray-500' }}"></i>
                                    <span>My Points</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('client.store.index') }}"
                                    class="flex items-center p-2 text-gray-700 rounded-lg hover:bg-green-50 transition-colors duration-200 {{ request()->routeIs('client.store.*') || request()->routeIs('client.orders.*') ? 'bg-green-50 text-green-700 font-medium' : '' }}">
                                    <i
                                        class="fas fa-gift w-6 {{ request()->routeIs('client.store.*') || request()->routeIs('client.orders.*') ? 'text-green-600' : 'text-gray-500' }}"></i>
                                    <span>Rewards Store</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('client.reviews.index') }}"
                                    class="flex items-center p-2 text-gray-700 rounded-lg hover:bg-green-50 transition-colors duration-200 {{ request()->routeIs('client.reviews.index') || request()->routeIs('client.reviews.show') ? 'bg-green-50 text-green-700 font-medium' : '' }}">
                                    <i
                                        class="fas fa-star w-6 {{ request()->routeIs('client.reviews.index') || request()->routeIs('client.reviews.show') ? 'text-green-600' : 'text-gray-500' }}"></i>
