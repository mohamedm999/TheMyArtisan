                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow border border-gray-100 mt-6">
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <a href="{{ route('artisan.profile.debug') }}" 
                                       class="mr-2 text-amber-600 text-xs">Debug</a>
                                ...
                                @if (session('debug_last_experience'))
                                <div class="mb-4 bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative">
                                    <strong>Debug:</strong> Last experience added: {{ session('debug_last_experience')->position }} at {{ session('debug_last_experience')->company_name }}
                                </div>
                                @endif
                                ...
                                <div class="space-y-6">
                                    <!-- Debug info -->
                                    @php
                                        $workExperiencesCount = isset($workExperiences) ? $workExperiences->count() : 0;
                                    @endphp
                                    <div class="text-xs text-gray-500">Debug: Found {{ $workExperiencesCount }} work experiences</div>
