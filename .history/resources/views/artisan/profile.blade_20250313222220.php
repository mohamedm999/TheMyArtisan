                                ...
                                <div class="flex flex-col items-center">
                                    <div class="w-32 h-32 rounded-full overflow-hidden mb-4">
                                        @if($artisanProfile->profile_photo)
                                            <img src="{{ Storage::url('profile_photos/'.$artisanProfile->profile_photo) }}" alt="{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}" class="w-full h-full object-cover">
                                        @else
                                            <div class="w-full h-full bg-amber-200 flex items-center justify-center text-amber-600 text-3xl font-bold">
                                                {{ strtoupper(substr(Auth::user()->firstname, 0, 1) . substr(Auth::user()->lastname, 0, 1)) }}
                                            </div>
                                        @endif
                                    </div>
                                    <h2 class="text-xl font-medium">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</h2>
                                    <p class="text-gray-500">{{ $artisanProfile->profession ?? 'Artisan' }}</p>

                                    <form action="{{ route('artisan.profile.photo') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                                        @csrf
                                ...
                                <div class="space-y-6">
                                    @forelse($workExperiences as $experience)
                                        <div class="border-l-2 border-amber-500 pl-4">
                                            <h4 class="font-medium">{{ $experience->title }}{{ $experience->company ? ', '.$experience->company : '' }}</h4>
            ...
            <div class="mt-3 text-center">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.work-experience') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="title" id="title" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="company" class="block text-sm font-medium text-gray-700">Company</label>
                        <input type="text" name="company" id="company" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-4 text-left">
                            <label for="start_date" class="block text-sm font-medium text-gray-700">Start Date</label>
                            <input type="date" name="start_date" id="start_date" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4 text-left">
                            <label for="end_date" class="block text-sm font-medium text-gray-700">End Date</label>
                            <input type="date" name="end_date" id="end_date" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
                    <div class="mb-4 text-left">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_current" id="is_current" class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded">
                            <label for="is_current" class="ml-2 block text-sm text-gray-900">Current Position</label>
                        </div>
                    </div>
                    <div class="mb-4 text-left">
                        <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                        <textarea name="description" id="description" rows="3" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
                    </div>
                    <div class="flex justify-between mt-5">
                        <button type="button" onclick="toggleModal('workExperienceModal')" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md">Cancel</button>
            ...
            <div class="mt-3 text-center">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.certification') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="issuer" class="block text-sm font-medium text-gray-700">Issuing Organization</label>
                        <input type="text" name="issuer" id="issuer" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="valid_until" class="block text-sm font-medium text-gray-700">Valid Until</label>
                        <input type="date" name="valid_until" id="valid_until" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="flex justify-between mt-5">
                        <button type="button" onclick="toggleModal('certificationModal')" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md">Cancel</button>
                        <button type="submit" class="px-4 py-2 bg-amber-600 text-white rounded-md">Save</button>
                    </div>
                </form>
            </div>
            ...
            <div class="mt-3 text-center">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.contact-info') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ $artisanProfile->phone }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="address" class="block text-sm font-medium text-gray-700">Address</label>
                        <input type="text" name="address" id="address" value="{{ $artisanProfile->address }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="city" class="block text-sm font-medium text-gray-700">City</label>
                        <input type="text" name="city" id="city" value="{{ $artisanProfile->city }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="country" class="block text-sm font-medium text-gray-700">Country</label>
                        <input type="text" name="country" id="country" value="{{ $artisanProfile->country }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="postal_code" class="block text-sm font-medium text-gray-700">Postal Code</label>
                        <input type="text" name="postal_code" id="postal_code" value="{{ $artisanProfile->postal_code }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="flex justify-between mt-5">
                        <button type="button" onclick="toggleModal('contactInfoModal')" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md">Cancel</button>
                        <button type="submit" class="px-4 py-2 bg-amber-600 text-white rounded-md">Save</button>
                    </div>
                </form>
            </div>
            ...
            <div class="mt-3 text-center">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.business-info') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="business_name" id="business_name" value="{{ $artisanProfile->business_name }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="business_registration_number" class="block text-sm font-medium text-gray-700">Registration Number</label>
                        <input type="text" name="business_registration_number" id="business_registration_number" value="{{ $artisanProfile->business_registration_number }}" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="insurance_details" class="block text-sm font-medium text-gray-700">Insurance Details</label>
                        <textarea name="insurance_details" id="insurance_details" rows="3" class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ $artisanProfile->insurance_details }}</textarea>
                    </div>
                    <div class="flex justify-between mt-5">
                        <button type="button" onclick="toggleModal('businessInfoModal')" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md">Cancel</button>
                        <button type="submit" class="px-4 py-2 bg-amber-600 text-white rounded-md">Save</button>
                    </div>
                </form>
            </div>
