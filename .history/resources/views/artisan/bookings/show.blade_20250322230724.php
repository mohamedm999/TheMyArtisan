                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500">{{ $booking->clientProfile->phone ?? 'No phone provided' }}</p>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-sm text-gray-900">
                                ...
                                {{ $booking->clientProfile->city }}, {{ $booking->clientProfile->state }} {{ $booking->clientProfile->postal_code }}
                            </p>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-900">{{ $booking->created_at->format('F d, Y') }}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500">Duration:</p>
                                    <p class="text-sm font-medium text-gray-900">{{ $booking->service->duration }} minutes</p>
                                </div>
                                <div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                @if ($booking->status == 'pending')
                                    <form action="{{ route('artisan.bookings.update', $booking) }}" method="POST" class="flex-1">
                                        @csrf
                                        @method('PUT')
