        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-gradient-to-r from-amber-500 to-amber-700 rounded-lg shadow-lg overflow-hidden">
                <div class="md:flex items-center justify-between px-6 py-8">
                    <div class="mb-4 md:mb-0">
                        <h1 class="text-2xl md:text-3xl font-bold text-white">Welcome back, {{ Auth::user()->firstname }}!</h1>
                        <p class="mt-2 text-amber-100">Manage your artisan profile, services and bookings from your personal dashboard.</p>
                    </div>
                    <div>
                ...
                <div class="bg-gradient-to-br from-amber-50 to-amber-100 p-6 rounded-lg shadow">
                    <div class="flex items-center mb-6">
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <div class="w-16 h-16 rounded-full bg-gradient-to-r from-amber-400 to-amber-600 flex items-center justify-center text-white text-xl font-bold">
                                    {{ strtoupper(substr(Auth::user()->firstname, 0, 1) . substr(Auth::user()->lastname, 0, 1)) }}
                                </div>
                            @endif
                        </div>
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-800">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</h3>
                            <p class="text-sm text-gray-600">{{ Auth::user()->email }}</p>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-200 text-amber-800 mt-1">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('artisan.profile') }}" class="text-amber-600 hover:text-amber-800 text-sm font-medium flex items-center">
                            ...
                            <div class="space-y-4">
                                @foreach($services as $service)
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <a href="{{ route('artisan.services.edit', $service->id) }}" class="text-gray-400 hover:text-amber-600">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow border border-gray-100">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($bookings as $booking)
                                            <tr>
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900">{{ $booking->date_formatted }}</div>
                                                </td>
                                                <td class="px-4 py-3 whitespace-nowrap">
                        ...
                        @else
                            <div class="text-center py-8 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                                ...
                                <p class="mt-1 text-sm text-gray-500">When clients book your services, they'll appear here.</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <a href="{{ route('artisan.services.create') }}" class="bg-white p-6 rounded-lg shadow border border-gray-100 hover:bg-gray-50 transition flex flex-col items-center text-center group">
                    ...
                    <a href="{{ route('artisan.portfolio') }}" class="bg-white p-6 rounded-lg shadow border border-gray-100 hover:bg-gray-50 transition flex flex-col items-center text-center group">
                    ...
                    <a href="{{ route('artisan.availability') }}" class="bg-white p-6 rounded-lg shadow border border-gray-100 hover:bg-gray-50 transition flex flex-col items-center text-center group">
                    ...
                    <a href="{{ route('artisan.settings') }}" class="bg-white p-6 rounded-lg shadow border border-gray-100 hover:bg-gray-50 transition flex flex-col items-center text-center group">
                        <div class="p-3 mb-3 rounded-full bg-purple-100 text-purple-600 group-hover:bg-purple-200 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
