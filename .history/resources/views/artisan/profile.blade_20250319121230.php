                                        ...
                                        <p class="flex items-center">
                                            ...
                                            @php
                                                ...
                                                if(isset($artisanProfile) && $artisanProfile) {
                                                    $addressParts = [];
                                                    if(!empty($artisanProfile->address)) $addressParts[] = $artisanProfile->address;
                                                    if(!empty($artisanProfile->city)) $addressParts[] = $artisanProfile->city;
                                                    if(!empty($artisanProfile->postal_code)) $addressParts[] = $artisanProfile->postal_code;
                                                    if(!empty($artisanProfile->country)) $addressParts[] = $artisanProfile->country;
                                                    $fullAddress = !empty($addressParts) ? implode(', ', $addressParts) : 'Paris, France';
                                                } else {
