                            ...
                            <div class="bg-white p-6 rounded-lg shadow border border-gray-100">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="mt-1">{{ $artisanProfile->profession ?? 'Not specified' }}</p>
                                    </div>

                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">About Me</h4>
                                        <p class="mt-1 text-sm text-gray-600">
                                            {{ $artisanProfile->about_me ?? 'No information provided yet.' }}
                                        </p>
                                    </div>

                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">Experience</h4>
                                        <p class="mt-1">{{ $artisanProfile->experience_years ?? 0 }} years</p>
                                    </div>

                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">Hourly Rate</h4>
                                        <p class="mt-1">€{{ $artisanProfile->hourly_rate ?? '0' }}</p>
                                    </div>

                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">Skills & Expertise</h4>
                                        <div class="mt-2 flex flex-wrap gap-2">
                                            @if(isset($artisanProfile->skills) && is_array($artisanProfile->skills) && count($artisanProfile->skills) > 0)
            ...
            <div class="mt-3 text-center">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.professional-info') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="profession" id="profession" value="{{ $artisanProfile->profession ?? '' }}" required
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="about_me" class="block text-sm font-medium text-gray-700">About Me</label>
                        <textarea name="about_me" id="about_me" rows="4"
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ $artisanProfile->about_me ?? '' }}</textarea>
                    </div>
                    <div class="mb-4 text-left">
                        <label for="skills" class="block text-sm font-medium text-gray-700">Skills (comma-separated)</label>
                        <input type="text" name="skills" id="skills" 
                            value="{{ isset($artisanProfile->skills) && is_array($artisanProfile->skills) ? implode(', ', $artisanProfile->skills) : '' }}"
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-4 text-left">
                            ...
                            <input type="number" name="experience_years" id="experience_years" min="0" 
                                value="{{ $artisanProfile->experience_years ?? 0 }}"
                                class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4 text-left">
                            ...
                            <input type="number" name="hourly_rate" id="hourly_rate" min="0" step="0.01"
                                value="{{ $artisanProfile->hourly_rate ?? 0 }}"
                                class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
                    <div class="flex justify-between mt-5">
