                            ...
                            <div class="bg-white p-6 rounded-lg shadow border border-gray-100 mt-6">
                                ...
                                @if (session('debug_last_experience'))
                                    <div
                                        ...
                                        <strong>Debug:</strong> Last experience added:
                                        {{ session('debug_last_experience')->position }} at
                                        {{ session('debug_last_experience')->company_name }}
                                    </div>
                                @endif
                                ...
                                <div class="space-y-6">
                                    ...
                                    @endphp
                                    <div class="text-xs text-gray-500">Debug: Found {{ $workExperiencesCount }} work
                                        experiences</div>
