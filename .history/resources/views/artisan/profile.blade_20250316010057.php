                                    ...
                                    @if (isset($certifications) && count($certifications) > 0)
                                        @foreach ($certifications as $certification)
                                            <div class="bg-gray-50 p-4 rounded-lg relative">
                                                ...
                                                <p class="text-sm text-gray-500">Issued by: {{ $certification->issuing_organization }}</p>
                                                ...
                                                <form action="{{ route('artisan.profile.certification.delete', $certification->id) }}" method="POST" class="absolute top-2 right-2">
                                                    @csrf
                                                    @method('DELETE')
