                                    ...
                                    <div
                                        ...
                                        <div class="mt-4 space-y-2">
                                            ...
                                            @elseif ($booking->clientProfile->user->id)
                                                ...
                                                <button type="button"
                                                    class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-400 bg-white cursor-not-allowed"
                                                    disabled>
