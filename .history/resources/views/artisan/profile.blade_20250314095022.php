                            ...
                            <div class="bg-amber-50 p-6 rounded-lg shadow">
                                <div class="flex flex-col items-center">
                                    <div class="w-32 h-32 rounded-full overflow-hidden mb-4">
                                        @if (isset($artisanProfile) && $artisanProfile && $artisanProfile->profile_photo)
                                    ...
                                    <p class="text-gray-500">{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->profession ?? 'Artisan' : 'Artisan' }}</p>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="space-y-2 text-sm">
                                        ...
                                        <p class="flex items-center">
                                            ...
                                            Reg: {{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->business_registration_number ?? 'Not specified' : 'Not specified' }}
                                        </p>
                                    </div>
                            ...
                            <div class="bg-white p-6 rounded-lg shadow border border-gray-100">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="mt-1">{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->profession ?? 'Not specified' : 'Not specified' }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1">{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->experience_years ?? 0 : 0 }} years</p>
                                    </div>

                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">Hourly Rate</h4>
                                        <p class="mt-1">€{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->hourly_rate ?? '0' : '0' }}</p>
                                    </div>

                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500">Skills & Expertise</h4>
                                        <div class="mt-2 flex flex-wrap gap-2">
                                            @if (isset($artisanProfile) && isset($artisanProfile->skills) && is_array($artisanProfile->skills) && count($artisanProfile->skills) > 0)
                                        ...
                                        @foreach ($workExperiences as $experience)
                                            <div class="border-l-2 border-amber-500 pl-4">
                                                <h4 class="font-medium">
                                                    {{ $experience->position }}{{ $experience->company_name ? ', ' . $experience->company_name : '' }}
                                                </h4>
                                    ...
                                    @if (isset($certifications) && count($certifications) > 0)
                                        @foreach ($certifications as $certification)
                                            <div class="bg-gray-50 p-4 rounded-lg relative">
                                                <h4 class="font-medium">{{ $certification->name }}</h4>
                                                <p class="text-sm text-gray-500">Issued by: {{ $certification->issuer }}
                                                </p>
                                                <p class="text-sm text-gray-500">Valid until:
                                                    {{ date('M Y', strtotime($certification->valid_until)) }}</p>
                                                <form
            ...
            <div class="mt-3 text-center">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.contact-info') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->phone : '' }}"
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="address" class="block text-sm font-medium text-gray-700">Address</label>
                        <input type="text" name="address" id="address" value="{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->address : '' }}"
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="city" class="block text-sm font-medium text-gray-700">City</label>
                        <input type="text" name="city" id="city" value="{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->city : '' }}"
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                        <label for="country" class="block text-sm font-medium text-gray-700">Country</label>
                        <input type="text" name="country" id="country" value="{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->country : '' }}"
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
                ...
                <form class="mt-4" action="{{ route('artisan.profile.professional-info') }}" method="POST">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <input type="text" name="profession" id="profession"
                            value="{{ isset($artisanProfile) && $artisanProfile ? $artisanProfile->profession ?? '' : '' }}" required
                            class="mt-1 focus:ring-amber-500 focus:border-amber-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4 text-left">
