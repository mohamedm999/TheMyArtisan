                                    ...
                                    @if (isset($certifications) && count($certifications) > 0)
                                        @foreach ($certifications as $certification)
                                            <div class="bg-gray-50 p-4 rounded-lg relative">
                                                ...
                                                <p class="text-sm text-gray-500">Issued by: {{ $certification->issuer }}</p>
                                                <p class="text-sm text-gray-500">Valid until: {{ date('M Y', strtotime($certification->valid_until)) }}</p>
                                                <form action="{{ route('artisan.profile.certification.delete', $certification->id) }}" method="POST"
