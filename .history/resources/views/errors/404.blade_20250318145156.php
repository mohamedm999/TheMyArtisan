...
@section('content')
    <div class="bg-white min-h-[70vh] flex items-center">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            <div class="mb-8">
                <svg class="h-32 w-32 mx-auto text-amber-500" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('home') }}"
                    class="px-6 py-3 bg-amber-600 text-white rounded-md shadow-md hover:bg-amber-700 transition-colors font-medium">
                    Return to Homepage
                </a>
                <a href="{{ route('contact') }}"
                    class="px-6 py-3 bg-white border border-gray-300 text-gray-700 rounded-md shadow-md hover:bg-gray-50 transition-colors font-medium">
                    Contact Support
                </a>
            </div>
            ...
            <div class="mt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <a href="{{ route('featured-artisans') }}"
                        class="p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors">
