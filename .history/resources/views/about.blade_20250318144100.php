...
@section('description', 'Learn about MyArtisan\'s mission to preserve Moroccan craft traditions and empower local artisans through sustainable digital infrastructure.')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-gray-600 mb-4">
                        Founded in {{ date('Y') - 2 }}, MyArtisan was born from a deep appreciation for Morocco's rich cultural heritage
                ...
                <div class="relative h-96 rounded-lg overflow-hidden shadow-xl">
                    <img src="{{ asset('images/about/workshop.jpg') }}" alt="Moroccan Artisan Workshop" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md text-center">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/team/team-1.jpg') }}" alt="Team Member" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-1">Hassan El Mansouri</h3>
                        <p class="text-amber-600 mb-3">Founder & CEO</p>
                        <p class="text-gray-600 mb-4">
                            With deep roots in Fes, Hassan bridges traditional craftsmanship with modern business approaches.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md text-center">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/team/team-2.jpg') }}" alt="Team Member" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow-md text-center">
                    <div class="h-64 bg-gray-200">
                        <img src="{{ asset('images/team/team-3.jpg') }}" alt="Team Member" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
    ...
    <div class="py-16 px-4 sm:px-6 lg:px-8 bg-amber-600">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <p class="text-lg text-amber-100 mb-8">
                Whether you're an artisan looking to share your craft, or a customer seeking authentic Moroccan craftsmanship,
                we invite you to be part of our community.
            </p>
            <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center">
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-amber-700 bg-white hover:bg-amber-50 shadow-md">
                    Join as Artisan
                </a>
                <a href="{{ route('client.artisans.index') }}" class="inline-flex items-center justify-center px-6 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-amber-700 shadow-md">
                    Browse Artisans
                </a>
            </div>
        </div>
