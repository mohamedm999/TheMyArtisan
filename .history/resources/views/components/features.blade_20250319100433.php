<section class="bg-white py-16 sm:py-24 relative isolate shadow-sm border-t border-gray-200" style="z-index: 20;">
    <!-- White background overlay to ensure no bleed-through -->
