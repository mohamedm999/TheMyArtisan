    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="lg:w-2/3">
                ...
                <!-- Testimonial snippet with avatar placeholders instead of images -->
                <div class="mt-8 flex items-center">
                    <div class="flex -space-x-2">
                        <div class="h-10 w-10 rounded-full ring-2 ring-white bg-amber-300 flex items-center justify-center text-amber-800 text-xs font-bold">MB</div>
                        <div class="h-10 w-10 rounded-full ring-2 ring-white bg-amber-400 flex items-center justify-center text-amber-900 text-xs font-bold">LT</div>
                        <div class="h-10 w-10 rounded-full ring-2 ring-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold">KS</div>
                    </div>
                    <div class="ml-4">
