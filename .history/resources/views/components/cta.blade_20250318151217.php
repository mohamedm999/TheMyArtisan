        ...
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="lg:w-2/3">
                ...
                <p class="mt-4 text-lg text-amber-100">
                    Join our platform to connect directly with skilled artisans or register as an artisan to showcase your craft to customers worldwide.
                </p>
                
                <!-- Testimonial snippet -->
                <div class="mt-8 flex items-center">
                    <div class="flex -space-x-2">
                        <img class="h-10 w-10 rounded-full ring-2 ring-white" src="{{ asset('images/testimonials/client-1.jpg') }}" alt="Customer">
                        <img class="h-10 w-10 rounded-full ring-2 ring-white" src="{{ asset('images/testimonials/client-2.jpg') }}" alt="Customer">
                        <img class="h-10 w-10 rounded-full ring-2 ring-white" src="{{ asset('images/testimonials/client-3.jpg') }}" alt="Customer">
                    </div>
                    <div class="ml-4">
            ...
            <div class="mt-10 lg:mt-0 lg:w-1/3">
                <div class="bg-white py-6 px-6 rounded-lg shadow-lg transform transition-all hover:scale-105">
                    <div class="space-y-5">
                        <a href="{{ route('client.artisans.index') }}" class="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-amber-600 hover:bg-amber-700">
                            <i class="fas fa-search mr-2"></i> Find Artisans
                        </a>
                        <a href="{{ route('register') }}" class="w-full flex items-center justify-center px-5 py-3 border border-amber-600 text-base font-medium rounded-md text-amber-600 bg-white hover:bg-amber-50">
