...
@keydown.arrow-left.window="slide = (slide - 1 + 4) % 4"
class="relative overflow-hidden">

  <!-- Background Slideshow - New addition -->
  <div class="absolute inset-0 z-0">
      <template x-for="(image, index) in [
          '/images/backgrounds/moroccan-workshop.jpg',
          '/images/backgrounds/pottery-artisan.jpg',
          '/images/backgrounds/textile-weaving.jpg',
          '/images/backgrounds/metal-crafting.jpg'
      ]" :key="index">
  ...
  <div class="absolute bottom-0 left-0 w-64 h-64 transform -translate-x-1/4 translate-y-1/4 bg-amber-500 rounded-full opacity-10 blur-3xl animate-blob z-1"></div>
  <div class="absolute top-0 right-0 w-80 h-80 transform translate-x-1/4 -translate-y-1/4 bg-amber-300 rounded-full opacity-10 blur-3xl animate-blob animation-delay-2000 z-1"></div>
  <div class="absolute top-1/2 left-1/3 w-48 h-48 bg-amber-600 rounded-full opacity-10 blur-3xl animate-blob animation-delay-4000 z-1"></div>
              ...
              <div class="relative mx-auto rounded-xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-900/40 to-amber-700/40 backdrop-blur-sm"
                  ...
                  <div class="aspect-w-16 aspect-h-10 relative group">
                      ...
                      <div class="absolute inset-0">
                          ...
                          <template x-for="(image, index) in [
                              '/images/products/zellige-tile-work.jpg',
                              '/images/products/berber-rugs.jpg',
                              '/images/products/copper-lanterns.jpg',
                              '/images/products/leather-goods.jpg'
                          ]" :key="index">
                              <div x-show="slide === index" class="absolute inset-0 transition-opacity duration-1000"
                                  ...
                                  <img :src="image" class="w-full h-full object-cover" alt="Moroccan artisan craftsmanship">
                      ...
                      <div class="absolute inset-y-0 left-0 flex items-center">
                          <button @click="slide = (slide - 1 + 4) % 4; stopAutoplay(); setTimeout(() => { startAutoplay() }, 10000)"
                      ...
                      <div class="absolute inset-y-0 right-0 flex items-center">
                          <button @click="slide = (slide + 1) % 4; stopAutoplay(); setTimeout(() => { startAutoplay() }, 10000)"
              ...
              <div class="grid grid-cols-4 gap-3 mt-6">
                  <template x-for="(image, index) in [
                      ...
                      <div class="overflow-hidden rounded-lg border-2 hover:border-amber-300 transition cursor-pointer transform hover:scale-105 duration-300 shadow-md"
                           ...
                           :class="{'border-amber-300 ring-2 ring-amber-500': slide === index, 'border-transparent': slide !== index}">
                          <img :src="image" class="w-full h-16 object-cover transition duration-700 hover:scale-110" :alt="`Moroccan craft ${index + 1}`">
                      </div>
                  </template>
              </div>
