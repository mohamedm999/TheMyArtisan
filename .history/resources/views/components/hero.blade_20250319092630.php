<div x-data="{
    ...
    <!-- Background Slideshow - Removed dark overlay -->
    <div class="absolute inset-0 z-0">
        <template x-for="(image, index) in backgroundImages" :key="index">
            <div x-show="slide === index"
                ...
                <!-- Light overlay for text readability, using a gradient instead of solid color -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 relative z-10">
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            ...
            <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-5 lg:text-left">
                ...
                <p class="mt-6 text-base text-white sm:text-xl lg:text-lg xl:text-xl leading-relaxed">
                ...
                <!-- Added testimonial element with improved contrast -->
                <div class="mt-8 p-4 bg-amber-900/40 backdrop-blur-sm rounded-lg border border-amber-700/30">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-white italic text-sm">"These authentic pieces transformed my home with
                                the spirit of Morocco."</p>
                            <p class="text-amber-200 text-xs mt-1">— Sarah J., New York</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12 lg:mt-0 lg:col-span-7">
                <div class="relative mx-auto rounded-xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-900/20 to-amber-700/20 backdrop-blur-sm"
                            ...
                            <template x-for="(image, index) in productImages" :key="index">
                                <div x-show="slide === index" class="absolute inset-0 transition-opacity duration-1000"
                                    ...
                                    <img :src="image" class="w-full h-full object-cover"
                                        ...
                                        onerror="this.src='{{ asset('images/backgrounds/placeholder.jpg') }}'; this.onerror=null;">
                                    <!-- Removed dark overlay from product images -->
                                </div>
                            </template>
                        </div>
                    ...
                    <div
                        class="absolute -top-4 -right-4 w-32 h-32 bg-amber-500/20 rounded-full blur-xl animate-pulse-slow">
                    </div>
                    <div
                        class="absolute -bottom-4 -left-4 w-32 h-32 bg-amber-300/20 rounded-full blur-xl animate-pulse-slow animation-delay-1000">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4 mt-6 text-center">
                    <div class="bg-amber-900/20 backdrop-blur-sm p-3 rounded-lg border border-amber-700/30">
                        <div class="text-amber-300 mb-1">
...
rames bounceX {
        @keyframes bounceX {
            ...
            100% {                transform: translateX(0);
                transform: translateX(0); animation-timing-function: cubic-bezier(0.8, 0, 1, 1);
                animation-timing-function: cubic-bezier(0.8, 0, 1, 1);
            }

            50% {   transform: translateX(5px);
                transform: translateX(5px);                animation-timing-function: cubic-bezier(0, 0, 0.2, 1);
                animation-timing-function: cubic-bezier(0, 0, 0.2, 1);
            }
        }
w styles for background slideshow */
        /* New styles for background slideshow */bg-cover {
...
per layering */
        /* Adjust z-index values for proper layering */z-0 {
        .z-0 {            z-index: 0;
            z-index: 0;
        }
...
sition duration */
        /* Enhanced transition duration */duration-1500 {
