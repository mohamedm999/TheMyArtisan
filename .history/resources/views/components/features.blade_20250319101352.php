<section class="features-section py-16 sm:py-24" style="background-color: white !important; margin-top: 0; position: relative; z-index: 10;">
    <!-- Simple container with no absolute positioning -->
