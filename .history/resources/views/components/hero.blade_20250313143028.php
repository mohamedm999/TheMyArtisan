<div x-data="{
    ...
    backgroundImages: [
        ...
        '{{ asset('images/backgrounds/0pottery-artisan.jpg') }}',
        '{{ asset('images/backgrounds/0textile-weaving.jpg') }}',
        '{{ asset('images/backgrounds/0metal-crafting.jpg') }}'
    ],
    productImages: [
        '{{ asset('images/products/0zellige-tile-work.jpg') }}',
        '{{ asset('images/products/0berber-rugs.jpg') }}',
        '{{ asset('images/products/0copper-lanterns.jpg') }}',
        '{{ asset('images/products/0leather-goods.jpg') }}'
    ],
    init() {
                ...
                <div class="mt-8 p-4 bg-amber-900/30 backdrop-blur-sm rounded-lg border border-amber-700/30">
                    <div class="flex items-center">
                        <div class="h-10 w-10 rounded-full overflow-hidden bg-amber-100">
                            <img src="{{ asset('images/testimonials/customer.jpg') }}" alt="Customer"
