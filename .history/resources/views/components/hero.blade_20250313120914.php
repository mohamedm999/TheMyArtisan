<div x-data="{
    ...
    <!-- Debug aid - shows available images -->
    <div class="hidden">
        <img src="{{ asset('images/debug-image-paths.txt') }}" alt="Debug Image Paths"
             onerror="console.log('Image paths are not loading correctly')">
    </div>

    <!-- Background Slideshow with direct images -->
    <div class="absolute inset-0 z-0">
        <!-- Static background as immediate fallback -->
        <div class="absolute inset-0 bg-amber-900 bg-opacity-90"></div>

        <!-- First background slide with direct reference and inline style -->
        <div x-show="slide === 0"
             class="absolute inset-0 bg-cover bg-center transition-opacity duration-1500"
             style="background-image: url('/images/backgrounds/Crafts-1.jpg');"
        ...
        <!-- Additional slides with direct references -->
        <div x-show="slide === 1"
             class="absolute inset-0 bg-cover bg-center transition-opacity duration-1500"
             style="background-image: url('/images/backgrounds/pottery-artisan.jpg');"
             x-transition:enter="transition ease-out duration-2000"
             x-transition:enter-start="opacity-0"
             x-transition:enter-end="opacity-100"
             x-transition:leave="transition ease-in duration-1000"
        ...
        <div x-show="slide === 2"
             class="absolute inset-0 bg-cover bg-center transition-opacity duration-1500"
             style="background-image: url('/images/backgrounds/textile-weaving.jpg');"
             x-transition:enter="transition ease-out duration-2000"
             x-transition:enter-start="opacity-0"
             x-transition:enter-end="opacity-100"
             x-transition:leave="transition ease-in duration-1000"
        ...
        <div x-show="slide === 3"
             class="absolute inset-0 bg-cover bg-center transition-opacity duration-1500"
             style="background-image: url('/images/backgrounds/metal-crafting.jpg');"
             x-transition:enter="transition ease-out duration-2000"
             x-transition:enter-start="opacity-0"
             x-transition:enter-end="opacity-100"
             x-transition:leave="transition ease-in duration-1000"
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            ...
            <div class="mt-12 lg:mt-0 lg:col-span-7">
                <div class="relative mx-auto rounded-xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-900/40 to-amber-700/40 backdrop-blur-sm"
                    ...
                    <!-- Main image carousel with direct image references -->
                    <div class="aspect-w-16 aspect-h-10 relative group">
                        <!-- Default background color in case images fail -->
                        <div class="absolute inset-0 bg-amber-800"></div>

                        <!-- Individual slide items with direct image paths -->
                        <div x-show="slide === 0" class="absolute inset-0 transition-opacity duration-1000"
                             ...
                             x-transition:leave-start="opacity-100"
                             x-transition:leave-end="opacity-0">
                            <img src="/images/products/zellige-tile-work.jpg"
                        ...
                        <div x-show="slide === 1" class="absolute inset-0 transition-opacity duration-1000"
                             x-transition:enter="transition ease-out duration-1000"
                             x-transition:enter-start="opacity-0"
                             x-transition:enter-end="opacity-100"
                             x-transition:leave="transition ease-in duration-800"
                             x-transition:leave-start="opacity-100"
                             x-transition:leave-end="opacity-0">
                            <img src="/images/products/berber-rugs.jpg"
                                 onerror="this.src='/images/default-product.jpg'; this.onerror=null;"
                                 class="w-full h-full object-cover"
                                 alt="Berber rugs">
                            <div class="absolute inset-0 bg-gradient-to-t from-amber-900/70 via-transparent to-transparent"></div>
                        ...
                        <div x-show="slide === 2" class="absolute inset-0 transition-opacity duration-1000"
                             x-transition:enter="transition ease-out duration-1000"
                             x-transition:enter-start="opacity-0"
                             x-transition:enter-end="opacity-100"
                             x-transition:leave="transition ease-in duration-800"
                             x-transition:leave-start="opacity-100"
                             x-transition:leave-end="opacity-0">
                            <img src="/images/products/copper-lanterns.jpg"
                                 onerror="this.src='/images/default-product.jpg'; this.onerror=null;"
                                 class="w-full h-full object-cover"
                                 alt="Copper lanterns">
                            <div class="absolute inset-0 bg-gradient-to-t from-amber-900/70 via-transparent to-transparent"></div>
                        ...
                        <div x-show="slide === 3" class="absolute inset-0 transition-opacity duration-1000"
                             x-transition:enter="transition ease-out duration-1000"
                             x-transition:enter-start="opacity-0"
                             x-transition:enter-end="opacity-100"
                             x-transition:leave="transition ease-in duration-800"
                             x-transition:leave-start="opacity-100"
                             x-transition:leave-end="opacity-0">
                            <img src="/images/products/leather-goods.jpg"
                                 onerror="this.src='/images/default-product.jpg'; this.onerror=null;"
                                 class="w-full h-full object-cover"
                                 alt="Leather goods">
                            <div class="absolute inset-0 bg-gradient-to-t from-amber-900/70 via-transparent to-transparent"></div>
                ...
                <!-- Enhanced image thumbnails with fixed paths -->
                <div class="grid grid-cols-4 gap-3 mt-6">
                    <div class="overflow-hidden rounded-lg border-2 hover:border-amber-300 transition cursor-pointer transform hover:scale-105 duration-300 shadow-md"
                        ...
                        <img src="/images/products/zellige-tile-work.jpg"
                             onerror="this.src='/images/default-thumbnail.jpg'; this.onerror=null;"
                    ...
                    <div class="overflow-hidden rounded-lg border-2 hover:border-amber-300 transition cursor-pointer transform hover:scale-105 duration-300 shadow-md"
                         @click="slide = 3; stopAutoplay(); setTimeout(() => { startAutoplay() }, 10000)"
                         :class="{'border-amber-300 ring-2 ring-amber-500': slide === 3, 'border-transparent': slide !== 3}">
                        <img src="/images/products/leather-goods.jpg"
                             onerror="this.src='/images/default-thumbnail.jpg'; this.onerror=null;"
                             class="w-full h-16 object-cover transition duration-700 hover:scale-110"
                             alt="Leather goods">
