<section class="bg-white py-16 sm:py-24 relative w-full border-t border-gray-200">
    <!-- Full-width white background to ensure no dark edges -->
    <div class="absolute inset-0 bg-white w-full"></div>
