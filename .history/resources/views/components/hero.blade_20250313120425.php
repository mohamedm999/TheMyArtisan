<div x-data="{
    ...
    <!-- Background Slideshow - Fixed paths -->
    <div class="absolute inset-0 z-0">
        <template
            x-for="(image, index) in [
          '{{ asset('images/backgrounds/Crafts-1.jpg') }}',
          '{{ asset('images/backgrounds/pottery-artisan.jpg') }}',
          '{{ asset('images/backgrounds/textile-weaving.jpg') }}',
          '{{ asset('images/backgrounds/metal-crafting.jpg') }}'
      ]"
            :key="index">
            <div x-show="slide === index"
                class="absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1500"
                :style="`background-image: url('${image}'), url('{{ asset('images/fallback-background.jpg') }}');`"
            ...
            <div class="mt-12 lg:mt-0 lg:col-span-7">
                <div class="relative mx-auto rounded-xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-900/40 to-amber-700/40 backdrop-blur-sm"
                    ...
                    <div class="aspect-w-16 aspect-h-10 relative group">
                        <!-- Main image carousel with fixed paths -->
                        <div class="absolute inset-0">
                            <!-- Updated with corrected image paths -->
                            <template
                                x-for="(image, index) in [
                              '{{ asset('images/products/zellige-tile-work.jpg') }}',
                              '{{ asset('images/products/berber-rugs.jpg') }}',
                              '{{ asset('images/products/copper-lanterns.jpg') }}',
                              '{{ asset('images/products/leather-goods.jpg') }}'
                          ]"
                                :key="index">
                                <div x-show="slide === index" class="absolute inset-0 transition-opacity duration-1000"
                                    ...
                                    <img :src="image" 
                                         @error="$el.src = '{{ asset('images/fallback-product.jpg') }}'" 
                                         class="w-full h-full object-cover"
                                         alt="Moroccan artisan craftsmanship">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-amber-900/70 via-transparent to-transparent"></div>
                                </div>
                            </template>
                        </div>
                    ...
                    <template
                      ...
                      '{{ asset('images/products/leather-goods.jpg') }}'
                        ...
                        <div class="overflow-hidden rounded-lg border-2 hover:border-amber-300 transition cursor-pointer transform hover:scale-105 duration-300 shadow-md"
                            ...
                            <img :src="image" 
                                 @error="$el.src = '{{ asset('images/fallback-thumbnail.jpg') }}'"
