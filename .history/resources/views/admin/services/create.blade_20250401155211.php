    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('admin.services.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="user_id" class="block text-gray-700 text-sm font-bold mb-2">Service
                                    Provider</label>
            ...
            $q->where('name', 'artisan');
                            ...
                            <button type="submit"
                                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Create
                                Service</button>
                        </form>
                    </div>
                </div>
