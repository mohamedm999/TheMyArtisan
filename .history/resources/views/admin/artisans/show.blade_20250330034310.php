                        ...
                        <div class="md:w-1/3 mb-6 md:mb-0 md:pr-6">
                            <div class="flex justify-center">
                                @if ($artisan->artisanProfile && $artisan->artisanProfile->avatar)
                                    <img src="{{ Storage::url($artisan->artisanProfile->avatar) }}"
                                ...
                                @if ($artisan->artisanProfile)
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                        <div>
                                            ...
                                            <p class="font-medium">{{ $artisan->artisanProfile->specialty ?? 'Not specified' }}
                                            </p>
                                        </div>
                                        <div>
                                            <p class="text-gray-600">Experience</p>
                                            <p class="font-medium">{{ $artisan->artisanProfile->experience ?? 'Not specified' }}
                                                years</p>
                                        </div>
                                        <div>
                                            <p class="text-gray-600">Phone</p>
                                            <p class="font-medium">{{ $artisan->artisanProfile->phone ?? 'Not specified' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-gray-600">Location</p>
                                            <p class="font-medium">
                                                {{ $artisan->artisanProfile->city ?? 'Not specified' }}{{ $artisan->artisanProfile->city && $artisan->artisanProfile->country ? ', ' : '' }}{{ $artisan->artisanProfile->country ?? '' }}
                                            </p>
                                        </div>
                                        <div class="col-span-2">
                                            <p class="text-gray-600">Bio</p>
                                            <p class="font-medium">{{ $artisan->artisanProfile->bio ?? 'No bio available' }}</p>
                                        </div>
                                    </div>
                                @else
