                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm">
                                                <span class="font-medium">
                                                    {{ $artisan->artisanProfile && $artisan->artisanProfile->services ? $artisan->artisanProfile->services->count() : 0 }}
                                                </span>
                                                Services
                                            </div>
                                            @if ($artisan->artisanProfile && $artisan->artisanProfile->reviews)
                                                <div class="flex items-center">
                                                    <div class="flex text-yellow-400">
                                                        @php
                                                            $avgRating =
                                                                $artisan->artisanProfile->reviews->avg('rating') ?? 0;
                                                        @endphp
                                                        @for ($i = 1; $i <= 5; $i++)
