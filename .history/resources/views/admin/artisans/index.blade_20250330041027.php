                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 font-medium">
                                                @if ($artisan->artisanProfile)
                                                    {{ $artisan->artisanProfile->specialty ?? $artisan->artisanProfile->speciality ?? 'Not specified' }}
                                                @else
                                                    Not specified
                                                @endif
                                            </div>
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($artisan->artisanProfile)
                                                <div class="text-sm text-gray-900">
                                                    ...
                                                    @elseif($artisan->artisanProfile->address)
                                                        {{ $artisan->artisanProfile->address }}
                                                    @else
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm">
                                                <span class="font-medium">
                                                    @if ($artisan->artisanProfile && isset($artisan->artisanProfile->services))
                                            ...
                                            @if ($artisan->artisanProfile && method_exists($artisan->artisanProfile, 'getAverageRatingAttribute'))
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="text-xs text-gray-500 ml-1">
                                                        ({{ $artisan->artisanProfile->getTotalReviewsAttribute() ?? 0 }})
                                                    </span>
                                                </div>
                                            @endif
                                        </td>
