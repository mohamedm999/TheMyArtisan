                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($artisans as $artisan)
                                    <tr class="hover:bg-gray-50">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                @if ($artisan->artisanProfile && $artisan->artisanProfile->categories->count() > 0)
                                                    ...
                                                    @if ($artisan->artisanProfile->categories->count() > 3)
                                                        <span
                                                            class="text-xs text-gray-500">+{{ $artisan->artisanProfile->categories->count() - 3 }}
                                                            more</span>
                                                    @endif
                                                @else
                                            ...
                                            @if ($artisan->artisanProfile)
                                                <div class="text-sm text-gray-900">
                                                    @if ($artisan->artisanProfile->city && $artisan->artisanProfile->country)
                                                        ...
                                                        {{ $artisan->artisanProfile->country->name }}
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm">
                                                <span class="font-medium">{{ $artisan->artisanProfile ? $artisan->artisanProfile->services->count() : 0 }}</span>
                                                Services
                                            </div>
                                            @if ($artisan->artisanProfile)
                                                <div class="flex items-center">
