                                ...
                                @if ($artisan->artisanProfile)
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium">
                                                {{ $artisan->artisanProfile->experience ?? 'Not specified' }}
                                                years</p>
                                        </div>
                                        <div>
                                            <p class="text-gray-600">Phone</p>
                                            <p class="font-medium">{{ $artisan->artisanProfile->phone ?? 'Not specified' }}
                                            </p>
                                        </div>
                                        <div>
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <p class="font-medium">
                                                {{ $artisan->artisanProfile->bio ?? 'No bio available' }}</p>
                                        </div>
                                    </div>
                                @else
