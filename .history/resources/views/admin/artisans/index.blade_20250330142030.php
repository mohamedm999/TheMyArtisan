                                ...
                                @forelse ($artisans as $artisan)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                @if ($artisan->artisanProfile && isset($artisan->artisanProfile->categories) && count($artisan->artisanProfile->categories) > 0)
                                                    ...
                                                    @endforeach
                                                    @if (count($artisan->artisanProfile->categories) > 3)
                                                        <span class="text-xs text-gray-500">+{{ count($artisan->artisanProfile->categories) - 3 }} more</span>
                                                    @endif
                                                @else
                                            ...
                                            @if ($artisan->artisanProfile)
                                                <div class="text-sm text-gray-900">
                                                    @if ($artisan->artisanProfile->city_id && $artisan->artisanProfile->city)
                                                        {{ $artisan->artisanProfile->city->name ?? 'Unknown City' }},
                                                        @if ($artisan->artisanProfile->country_id && $artisan->artisanProfile->country)
                                                            {{ $artisan->artisanProfile->country->name ?? 'Unknown Country' }}
                                                        @else
                                                            Unknown Country
                                                        @endif
                                                    @elseif($artisan->artisanProfile->city && is_string($artisan->artisanProfile->city))
                                                        {{ $artisan->artisanProfile->city }},
                                                        {{ is_string($artisan->artisanProfile->country) ? $artisan->artisanProfile->country : 'Unknown Country' }}
                                                    @else
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm">
                                                <span class="font-medium">
                                                    {{ $artisan->artisanProfile && isset($artisan->artisanProfile->services) ? count($artisan->artisanProfile->services) : 0 }}
                                                </span>
                                                Services
                                            </div>
                                            @if ($artisan->artisanProfile && isset($artisan->artisanProfile->reviews) && count($artisan->artisanProfile->reviews) > 0)
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="text-xs text-gray-500 ml-1">
                                                        ({{ count($artisan->artisanProfile->reviews) }})
                                                    </span>
                                                </div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4">
                                            @if ($artisan->artisanProfile)
                                                @php
                                                    $status = $artisan->artisanProfile->status ?? 'pending';
                                                @endphp
                                                @if ($status === 'approved')
