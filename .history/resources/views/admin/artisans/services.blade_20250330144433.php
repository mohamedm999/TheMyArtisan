...
@section('content')
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl font-semibold text-gray-800">Services for {{ $artisan->firstname }}
                        {{ $artisan->lastname }}</h2>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex items-center mb-6 pb-6 border-b border-gray-200">
                        <div class="flex-shrink-0 h-16 w-16 rounded-full overflow-hidden bg-gray-100 mr-4">
                            ...
                            @else
                                <div
                                    class="h-16 w-16 bg-blue-100 text-blue-800 flex items-center justify-center rounded-full">
                                    <span
                                        class="text-xl font-bold">{{ substr($artisan->firstname, 0, 1) }}{{ substr($artisan->lastname, 0, 1) }}</span>
                                </div>
                            @endif
                        </div>
                        <div>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div
                                                            ...
                                                            @else
                                                                <div
                                                                    class="h-10 w-10 bg-blue-50 text-blue-600 flex items-center justify-center">
                                    ...
                                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                        <div class="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
                                            ...
                                            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                                {{ number_format($service->price, 2) }} MAD | {{ $service->duration }}
                                                minutes
                                            </p>
                                        </div>
    ...
    <div id="service-details-modal"
        class="fixed inset-0 bg-gray-500 bg-opacity-75 hidden flex items-center justify-center" style="z-index: 50;">
        <div class="bg-white rounded-lg overflow-hidden shadow-xl max-w-2xl w-full">
            ...
            <div class="px-4 py-3 sm:px-6 bg-gray-50 border-t border-gray-200 text-right">
                <button type="button" onclick="hideServiceDetails()"
                    class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none">
                    Close
                </button>
            </div>
        </div>
