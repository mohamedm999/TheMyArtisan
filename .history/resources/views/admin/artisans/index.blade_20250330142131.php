                                    ...
                                    <tr class="hover:bg-gray-50">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                @if (
                                                    $artisan->artisanProfile &&
                                                        ...
                                                        count($artisan->artisanProfile->categories) > 0)
                                                    ...
                                                    @if (count($artisan->artisanProfile->categories) > 3)
                                                        <span
                                                            class="text-xs text-gray-500">+{{ count($artisan->artisanProfile->categories) - 3 }}
                                                            more</span>
                                                    @endif
                                                @else
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($artisan->artisanProfile)
                                                ...
                                                <div class="text-xs text-gray-500">
                                                    Service radius: {{ $artisan->artisanProfile->service_radius ?? '0' }}
                                                    km
                                                </div>
                                            @else
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @if (
                                                $artisan->artisanProfile &&
                                                    ...
                                                    count($artisan->artisanProfile->reviews) > 0)
                                                <div class="flex items-center">
