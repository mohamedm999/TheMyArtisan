                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.artisans.export') }}" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">
                    ...
                    <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                        <form method="GET" action="{{ route('admin.artisans.index') }}" class="md:flex md:flex-wrap md:items-end">
                                ...
                                @forelse ($artisans as $artisan)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                @if($artisan->artisanProfile && $artisan->artisanProfile->categories->count() > 0)
                                        ...
                                        <td class="px-6 py-4">
                                            @if($artisan->artisanProfile)
                                                <div class="text-sm text-gray-900">
                                                    @if($artisan->artisanProfile->city && $artisan->artisanProfile->country)
                                                        {{ $artisan->artisanProfile->city->name }}, {{ $artisan->artisanProfile->country->name }}
                                                    @elseif($artisan->artisanProfile->city)
                                                        {{ $artisan->artisanProfile->city->name }}
                                                    @elseif($artisan->artisanProfile->city)
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm">
                                                <span class="font-medium">{{ $artisan->services->count() }}</span> Services
                                            </div>
                                            @if($artisan->artisanProfile)
                                                <div class="flex items-center">
                                                    <div class="flex text-yellow-400">
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            @if ($i <= round($artisan->artisanProfile->getAverageRatingAttribute()))
