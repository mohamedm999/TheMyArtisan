        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-extrabold text-gray-900">
                    <i class="fas fa-folder-plus text-blue-600 mr-2"></i> Create New Category
                </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition duration-150 ease-in-out">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Enter Font Awesome icon class (e.g. fa-hammer, fa-tools)
                            </p>
                        </div>
