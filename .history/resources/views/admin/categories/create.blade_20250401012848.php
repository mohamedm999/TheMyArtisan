            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon') }}" placeholder="e.g. fa-hammer"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Upload a representative image for this category (jpg, png, gif)</p>
                    </div>
