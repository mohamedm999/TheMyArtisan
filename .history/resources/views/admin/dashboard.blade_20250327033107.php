                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-4">
                            <a href="{{ route('admin.users.index') }}"
                                class="group flex flex-col items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-blue-50 hover:border-blue-200 transition-all duration-200">
                                <div
                                    class="w-12 h-12 mb-3 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center group-hover:bg-blue-200 transition-colors duration-200">
                                    <i class="fas fa-user-plus"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-blue-700">Manage
                                    Users</span>
                            </a>

                            <a href="{{ route('admin.artisans.index') }}"
                                class="group flex flex-col items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-amber-50 hover:border-amber-200 transition-all duration-200">
                                <div
                                    class="w-12 h-12 mb-3 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center group-hover:bg-amber-200 transition-colors duration-200">
                                    <i class="fas fa-hammer"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-amber-700">Manage
                                    Artisans</span>
                            </a>

                            <a href="{{ route('admin.services.index') }}"
                                class="group flex flex-col items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-orange-50 hover:border-orange-200 transition-all duration-200">
                                <div
                                    class="w-12 h-12 mb-3 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center group-hover:bg-orange-200 transition-colors duration-200">
                                    <i class="fas fa-briefcase"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-orange-700">Manage
                                    Services</span>
                            </a>

                            <a href="{{ route('admin.categories.index') }}"
                                class="group flex flex-col items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-teal-50 hover:border-teal-200 transition-all duration-200">
                                <div
                                    class="w-12 h-12 mb-3 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center group-hover:bg-teal-200 transition-colors duration-200">
                                    <i class="fas fa-tags"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-teal-700">Manage
                                    Categories</span>
                            </a>

                            <a href="{{ route('admin.bookings.index') }}"
                                class="group flex flex-col items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-purple-50 hover:border-purple-200 transition-all duration-200">
                                <div
                                    class="w-12 h-12 mb-3 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center group-hover:bg-purple-200 transition-colors duration-200">
                                    <i class="fas fa-calendar-check"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-700">Manage
                                    Bookings</span>
                            </a>

                            <a href="{{ route('admin.settings.index') }}"
                                class="group flex flex-col items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-gray-50 hover:border-gray-300 transition-all duration-200">
                                <div
                                    class="w-12 h-12 mb-3 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center group-hover:bg-gray-200 transition-colors duration-200">
                                    <i class="fas fa-cog"></i>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">System
                                    Settings</span>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex-shrink-0 mr-3">
                                            <div
                                                ...
                                                {{ ($activity->type ?? 'default') === 'user'
                                                    ? 'bg-blue-100 text-blue-600'
                                                    : (($activity->type ?? 'default') === 'booking'
                                                        ? 'bg-purple-100 text-purple-600'
                                                        : (($activity->type ?? 'default') === 'service'
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                                <div class="flex items-center">
                                    <div
                                        class="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center text-primary-600 mr-3">
