                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div class="font-medium">{{ $user->artisanProfile->specialty ?? 'Not specified' }}</div>
                                            </div>
                                            <div>
                                                <label class="block text-sm text-gray-500">Experience</label>
                                                <div class="font-medium">{{ $user->artisanProfile->experience ?? '0' }} years</div>
                                            </div>
                                            <div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div class="font-medium">{{ $user->clientProfile->address ?? 'Not provided' }}</div>
                                            </div>
                                            <div>
                                                <label class="block text-sm text-gray-500">City</label>
                                                <div class="font-medium">{{ $user->clientProfile->city ?? 'Not provided' }}</div>
                                            </div>
                                            <div>
                                                <label class="block text-sm text-gray-500">Country</label>
                                                <div class="font-medium">{{ $user->clientProfile->country ?? 'Not provided' }}</div>
                                            </div>
                                        </div>
                                        ...
                                        @if (isset($user->clientProfile->preferences))
                                            <div class="mt-4">
                                                ...
                                                <div class="mt-1 text-gray-800">{{ $user->clientProfile->preferences }}</div>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                                        ...
                                        <div>
                                            ...
                                            <div class="font-medium">
                                                @if ($user->email_verified_at)
                                                    <span class="text-green-600"><i class="fas fa-check-circle mr-1"></i> Verified on {{ $user->email_verified_at->format('M d, Y') }}</span>
                                                @else
