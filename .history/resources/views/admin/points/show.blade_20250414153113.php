        ...
        <div class="p-4 md:p-6">
            ...
            <div class="mb-6 bg-gray-50 rounded-lg p-6 border border-gray-200">
                <div class="flex flex-col md:flex-row md:items-center">
                    <div
                        class="flex-shrink-0 h-20 w-20 rounded-full bg-primary-100 flex items-center justify-center text-primary-700 text-2xl">
                                ...
                                @forelse($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="{{ $transaction->points > 0 ? 'text-green-600' : 'text-red-600' }} font-medium">
