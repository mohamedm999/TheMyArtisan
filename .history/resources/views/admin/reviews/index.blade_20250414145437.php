            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="mt-2 md:mt-0">
                    <form action="{{ route('admin.reviews.index') }}" method="GET" class="flex items-center">
                        <select name="filter"
                            class="rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50 mr-2">
                            ...
                            <option value="reported" {{ request('filter') == 'reported' ? 'selected' : '' }}>Reported
                            </option>
                        </select>
                        <button type="submit"
                                    ...
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">
                                                ...
                                                {{ $review->artisanProfile->user->lastname ?? '' }}
                                            </div>
                                            <div class="text-sm text-gray-500">
