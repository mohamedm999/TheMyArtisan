                                    ...
                                    <div class="flex items-start p-3 rounded-lg hover:bg-gray-50 transition-colors duration-150">
                                        <div class="flex-shrink-0 mr-3">
                                            <div class="w-10 h-10 rounded-full flex items-center justify-center
                                                {{ ($activity->type ?? 'default') === 'user' ? 'bg-blue-100 text-blue-600' :
                                                   (($activity->type ?? 'default') === 'booking' ? 'bg-purple-100 text-purple-600' :
                                                   (($activity->type ?? 'default') === 'service' ? 'bg-orange-100 text-orange-600' :
