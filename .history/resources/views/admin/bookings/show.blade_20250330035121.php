                            ...
                            <div class="mt-4 text-sm">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="font-medium">{{ $booking->client->clientProfile->phone ?? 'Not provided' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-500">Address</p>
                                        <p class="font-medium">{{ $booking->client->clientProfile->address ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    ...
                                    @else
                                        <div class="h-10 w-10 rounded-full bg-green-200 flex items-center justify-center text-green-600 font-medium">
                            ...
                            <div class="mt-4 text-sm">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <p class="text-gray-500">Phone</p>
                                        <p class="font-medium">{{ $booking->artisan->artisanProfile->phone ?? 'Not provided' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-500">Specialty</p>
                                        <p class="font-medium">{{ $booking->artisan->artisanProfile->specialty ?? 'Not specified' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
