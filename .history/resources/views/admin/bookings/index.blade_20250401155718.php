                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                @if ($booking->booking_date)
                                                    {{ $booking->booking_date instanceof \DateTime ? $booking->booking_date->format('M d, Y') : \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y') }}
                                                @else
                                                    Unknown
                                                @endif
                                            </div>
                                            <div class="text-sm text-gray-500">
                                                @if ($booking->booking_date)
                                                    {{ $booking->booking_date instanceof \DateTime ? $booking->booking_date->format('h:i A') : \Carbon\Carbon::parse($booking->booking_date)->format('h:i A') }}
                                                @else
                                                    No time set
                                                @endif
                                            </div>
