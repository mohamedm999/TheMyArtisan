                            ...
                            <div class="product-details">
                                ...
                                <div class="media">
                                    <div class="mr-3">
                                        ...
                                        <img src="{{ asset('storage/' . $order->product->image) }}" alt="{{ $order->product->name }}" class="img-thumbnail" style="width: 80px; height: 80px; object-fit: cover;">
                                        @else
                                        <div class="bg-light text-center rounded" style="width: 80px; height: 80px; line-height: 80px;">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted mb-1">{{ $order->product->category ?? 'Uncategorized' }}</p>
                                        <div class="d-flex align-items-center">
                                            <div class="mr-3">
                                                <span class="font-weight-bold text-primary">{{ number_format($order->product->points_cost) }}</span>
                            ...
                            <div class="client-details">
                                <div class="media">
                                    <div class="mr-3">
                                        ...
                                        <img src="{{ asset('storage/' . $order->user->avatar) }}" alt="{{ $order->user->firstname }}" class="img-thumbnail rounded-circle" style="width: 60px; height: 60px; object-fit: cover;">
                                        @else
                                        <div class="bg-primary text-white text-center rounded-circle" style="width: 60px; height: 60px; line-height: 60px;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Points Spent</th>
                                            <td><strong class="text-primary">{{ number_format($order->points_spent) }}</strong> points</td>
                                        </tr>
                            ...
                            <li class="list-group-item border-0 d-flex">
                                ...
                                <div class="timeline-content">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="font-weight-bold">Status changed to <span class="text-capitalize">{{ $history->status }}</span></span>
                                    ...
                                    @endif
                                    @if($history->user)
                                    <small class="text-info">By: {{ $history->user->firstname }} {{ $history->user->lastname }}</small>
                                    @endif
                                </div>
                            </li>
                            @endforeach
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.store.orders.update-admin-notes', $order->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">These notes are for internal use only and not visible to clients</small>
                        </div>
                    ...
                    <div class="quick-actions">
                        ...
                        <div class="mt-3">
                            ...
                            <form action="{{ route('admin.store.orders.cancel', $order->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to cancel this order? This will return points to the client.');">
                                @csrf
                            ...
                            <a href="{{ route('admin.store.orders.email', $order->id) }}" class="btn btn-info btn-block mb-2">
                                <i class="fas fa-envelope mr-1"></i> Email Client
                            </a>
                            
                            <a href="{{ route('admin.clients.show', $order->user_id) }}" class="btn btn-secondary btn-block">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="client-points-summary">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('admin.clients.points', $order->user_id) }}" class="btn btn-outline-primary btn-sm btn-block">
