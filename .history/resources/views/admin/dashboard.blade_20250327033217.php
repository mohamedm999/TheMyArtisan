                            ...
                            <div class="space-y-4">
                                @if (isset($recentActivities) && count($recentActivities) > 0)
                                    @foreach ($recentActivities as $activity)
                                        <div
                                            class="flex items-start p-3 rounded-lg border border-gray-100 hover:bg-gray-50">
                                            <div class="flex-shrink-0 mr-3">
                                                <div
                                                    class="w-10 h-10 rounded-full bg-blue-100 text-blue-500 flex items-center justify-center">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ app()->environment('production') ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800' }}">
                                        {{ app()->environment() }}
                                    </span>
                                </div>
                            </div>
