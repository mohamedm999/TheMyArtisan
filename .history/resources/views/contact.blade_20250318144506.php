...
@section('description', 'Get in touch with MyArtisan for questions about our platform, artisan services, or partnership opportunities.')
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500" required>
                                @error('first_name')
                            ...
                            <div>
                                ...
                                <input type="text" id="last_name" name="last_name" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500" required>
                                @error('last_name')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500" required>
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select id="subject" name="subject" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500" required>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500" required></textarea>
                            @error('message')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <label for="privacy" class="ml-2 text-sm text-gray-600">
                                I agree to the processing of my data as per the <a href="{{ route('privacy') }}" class="text-amber-600 hover:text-amber-500">Privacy Policy</a>.
                            </label>
                        </div>
                    ...
                    <div class="bg-amber-50 rounded-lg p-6 mb-8">
                        ...
                        <div class="flex items-start mb-6">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-gray-600">
                                    General Inquiries: <a href="mailto:info@myartisan.ma" class="text-amber-600 hover:text-amber-500">info@myartisan.ma</a><br>
                                    Support: <a href="mailto:support@myartisan.ma" class="text-amber-600 hover:text-amber-500">support@myartisan.ma</a><br>
                                    Artisan Relations: <a href="mailto:artisans@myartisan.ma" class="text-amber-600 hover:text-amber-500">artisans@myartisan.ma</a>
                                </p>
                            </div>
                        </div>
