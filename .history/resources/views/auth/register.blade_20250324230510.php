                    ...
                    <form class="mt-6 space-y-4" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex flex-col md:flex-row gap-3">
                                <div class="flex-1">
                                    <input type="radio" id="type_client" name="user_type" value="client" class="hidden peer" checked>
                                    <label for="type_client" class="flex items-center justify-center p-4 bg-white border border-amber-200 rounded-lg cursor-pointer peer-checked:border-amber-600 peer-checked:bg-amber-50 hover:bg-amber-50">
                                ...
                                <div class="flex-1">
                                    <input type="radio" id="type_artisan" name="user_type" value="artisan" class="hidden peer">
                                    <label for="type_artisan" class="flex items-center justify-center p-4 bg-white border border-amber-200 rounded-lg cursor-pointer peer-checked:border-amber-600 peer-checked:bg-amber-50 hover:bg-amber-50">
                                        <div class="text-center">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="terms" class="font-medium text-gray-700">
                                        {{ __('I agree to the') }}
                                        <a href="#" class="text-amber-600 hover:text-amber-500">{{ __('Terms of Service') }}</a>
                                        {{ __('and') }}
                                        <a href="#" class="text-amber-600 hover:text-amber-500">{{ __('Privacy Policy') }}</a>
                                    </label>
                                </div>
                            </div>
                        </div>
