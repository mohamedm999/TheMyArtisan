...
@section('content')
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-amber-50 to-orange-50">
        <div class="max-w-md w-full space-y-6 auth-form rounded-lg shadow-xl overflow-hidden">
            <!-- Morocco Andalusian Image -->
            <img src="{{ asset('images/Morocco – Andalusian.jpg') }}" alt="Moroccan Andalusian Art" class="form-hero-image">
                ...
                <form class="space-y-5" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group">
                        ...
                        <select id="role" name="role" required
                            ...
                            <option value="artisan" {{ old('role') == 'artisan' ? 'selected' : '' }}>{{ __('Artisan') }}</option>
                        </select>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="{{ route('login') }}" class="font-medium text-amber-600 hover:text-amber-500 transition-colors">
                                {{ __('Sign in') }}
                            </a>
                        </p>
                    </div>
