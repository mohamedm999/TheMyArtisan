...
@section('styles')
    <style>
        ...
        .login-image {
            background-image: url('/images/login/Morocco-Andalusian.jpg');
...
@section('content')
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="login-image hidden md:block md:w-1/2 relative">
            <div class="absolute inset-0 bg-gradient-to-r from-amber-700/40 to-transparent pattern-overlay"></div>
        ...
        <!-- Form Column -->
        <div class="md:w-1/2 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-amber-50">
            <!-- Mobile Image -->
            <div class="md:hidden w-full h-40 login-image rounded-lg mb-6 relative">
                <div class="absolute inset-0 bg-gradient-to-b from-amber-700/40 to-transparent pattern-overlay rounded-lg"></div>
            </div>
            ...
            <div class="max-w-md w-full space-y-8 auth-form rounded-lg shadow-lg p-8">
                ...
                <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        <button type="submit"
                            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-amber-600 hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-all duration-300">
