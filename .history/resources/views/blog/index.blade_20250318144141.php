...
@section('description', 'Discover stories of Moroccan artisans, traditional crafting techniques, and updates about the MyArtisan platform.')
    ...
    <div class="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
                ...
                <div class="col-span-full mb-12">
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg transition-transform hover:-translate-y-1 hover:shadow-xl">
                        <div class="aspect-w-16 aspect-h-9 lg:aspect-w-2 lg:aspect-h-1">
                            <img src="{{ asset('images/blog/featured.jpg') }}" alt="The Revival of Moroccan Zellige" class="w-full h-full object-cover">
                        </div>
                        <div class="p-8">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 mb-3">The Revival of Moroccan Zellige: Ancient Patterns in Modern Spaces</h2>
                            <p class="text-gray-600 mb-4">
                                How this intricate mosaic tilework is finding new appreciation in contemporary interior design around the world.
                            </p>
                            <div class="flex items-center">
                                <img class="h-10 w-10 rounded-full mr-4" src="{{ asset('images/team/team-2.jpg') }}" alt="Author">
                                <div>
                ...
                <!-- Regular Blog Post 1 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <h2 class="text-xl font-bold text-gray-900 mt-2 mb-3">Artisan Spotlight: The Leather Craftsmen of Fes</h2>
                        <p class="text-gray-600 mb-4">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <h2 class="text-xl font-bold text-gray-900 mt-2 mb-3">Sustainable Practices in Traditional Carpet Weaving</h2>
                        <p class="text-gray-600 mb-4">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <h2 class="text-xl font-bold text-gray-900 mt-2 mb-3">From Medina to Market: How MyArtisan is Helping Rural Craftsmen</h2>
                        <p class="text-gray-600 mb-4">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:-translate-y-1 hover:shadow-lg">
                    <div class="aspect-w-16 aspect-h-9">
                        <img src="{{ asset('images/blog/post-5.jpg') }}" alt="Blog Post" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <span class="text-sm text-gray-500">December 10, {{ date('Y')-1 }}</span>
                        <h2 class="text-xl font-bold text-gray-900 mt-2 mb-3">The Art of Moroccan Metalworking: Tools and Techniques</h2>
                        <p class="text-gray-600 mb-4">
            ...
            <div class="mt-16 flex justify-center">
                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                    ...
                    <a href="#" aria-current="page" class="z-10 bg-amber-50 border-amber-500 text-amber-600 relative inline-flex items-center px-4 py-2 border text-sm font-medium">1</a>
    ...
    <div class="bg-amber-50 py-16 px-4 sm:px-6 lg:px-8">
        <div class="max-w-xl mx-auto text-center">
            ...
            <form class="sm:flex justify-center">
                <input type="email" required class="w-full sm:max-w-xs px-4 py-3 border-gray-300 shadow-sm focus:ring-amber-500 focus:border-amber-500 block rounded-md sm:rounded-r-none" placeholder="Enter your email">
                <button type="submit" class="mt-3 sm:mt-0 w-full sm:w-auto bg-amber-600 text-white px-6 py-3 rounded-md sm:rounded-l-none hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2">
                    Subscribe
                </button>
            </form>
        </div>
