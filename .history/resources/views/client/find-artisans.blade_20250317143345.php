        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white">
                    ...
                    <div class="mb-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <form action="{{ route('client.find-artisans') }}" method="GET" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="availability" id="availability"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50">
                                        <option value="all" {{ request('availability') == 'all' ? 'selected' : '' }}>All Artisans</option>
                            ...
                            <div class="flex justify-end">
                                @if (request()->anyFilled(['search', 'category', 'location', 'sort', 'availability']))
                    ...
                    <!-- Pagination -->
                    @if (isset($artisans) && method_exists($artisans, 'lastPage') && $artisans->lastPage() > 1)
