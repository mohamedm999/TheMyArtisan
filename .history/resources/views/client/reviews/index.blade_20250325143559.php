            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-100">
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                                                <h3 class="text-xl font-semibold text-gray-900 mb-2 sm:mb-0">{{ $review->service->name }}</h3>
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="ml-2 text-sm font-medium text-gray-600">{{ date('M d, Y', strtotime($review->created_at)) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center mb-4">
                                                ...
                                                <span class="text-sm font-medium text-gray-700">Service by
                                                    <span class="text-green-700">{{ $review->artisanProfile->user->firstname }}
                ...
                @else
                    <div class="text-center py-16">
                        ...
                        <p class="mt-2 text-base text-gray-600 max-w-md mx-auto">You haven't submitted any reviews for your bookings. Reviews help other clients make informed decisions.</p>
                        <div class="mt-8">
