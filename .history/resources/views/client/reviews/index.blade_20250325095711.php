                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-2">
                                                <h3 class="text-lg font-medium text-gray-900">{{ $review->service->name }}
                                                </h3>
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="ml-1 text-sm text-gray-600">{{ date('M d, Y', strtotime($review->created_at)) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center mb-4">
                                                ...
                                                @else
                                                    <div
                                                        class="h-8 w-8 rounded-full bg-gradient-to-r from-green-400 to-blue-500 flex items-center justify-center mr-3">
                                                        <span class="text-white text-sm font-medium">
                                                            {{ substr($review->artisanProfile->user->firstname, 0, 1) }}
                                                        </span>
                                                    </div>
                                                @endif
                                                <span class="text-sm text-gray-700">Service by
                                                    {{ $review->artisanProfile->user->firstname }}
                                            ...
                                            @if ($review->response)
                                                <div class="mt-4 bg-gray-50 p-4 rounded-md">
                                                    <h4 class="text-sm font-medium text-gray-700">Response from Artisan:
                                                    </h4>
                                                    <p class="mt-1 text-sm text-gray-600">{{ $review->response }}</p>
                                                    <p class="mt-1 text-xs text-gray-500">Responded on
