...
<div class="container py-4">
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb bg-light">
            <li class="breadcrumb-item"><a href="{{ route('client.orders.index') }}">Your Orders</a></li>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <p class="mb-1"><strong>Points Spent:</strong> {{ number_format($order->points_spent) }}</p>
                        </div>
                        <div class="col-md-6">
                            ...
                            <p class="mb-1"><strong>Redeemed On:</strong> {{ $order->redeemed_at->format('M d, Y h:i A') }}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <img src="{{ asset('storage/' . $order->product->image) }}" alt="{{ $order->product->name }}" class="img-fluid">
                            @else
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="mb-0"><strong>Points:</strong> {{ number_format($order->points_spent) }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info mt-4">
                        <i class="fas fa-info-circle mr-1"></i> Your order is being processed. You will be notified when your order is shipped.
                    </div>
                    @endif
                </div>
