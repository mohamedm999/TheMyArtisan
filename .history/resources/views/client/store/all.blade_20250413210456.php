    ...
    <div class="container mx-auto px-4 py-4">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb bg-light">
                ...
                <li class="breadcrumb-item active" aria-current="page">All Rewards</li>
            </ol>
        </nav>

        <div class="row align-items-center mb-4">
            <div class="col">
                <h1 class="h2 mb-0">All Rewards</h1>
                <p class="text-muted">Browse our complete collection of rewards</p>
            </div>
            <div class="col-auto">
