                                ...
                                <div class="p-5">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">{{ $artisan->profession ?? $artisan->speciality ?? 'Artisan' }}</p>
                                        </div>
                                        <button class="ml-auto text-red-500 hover:text-red-700 focus:outline-none unsave-button"
                ...
                button.addEventListener('click', function() {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            toast.innerText = data.message || 'Artisan removed from your saved list';
                            ...
                            setTimeout(() => {
                                ...
                                const remainingCards = document.querySelectorAll('[id^="artisan-card-"]');
