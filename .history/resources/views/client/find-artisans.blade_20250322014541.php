                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="availability" id="availability"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50">
                                        <option value="all" {{ request('availability') == 'all' ? 'selected' : '' }}>All
                                            Artisans</option>
                                        <option value="available"
                                            {{ request('availability') == 'available' ? 'selected' : '' }}>Available Now
                                        </option>
                                        <option value="unavailable"
                                            {{ request('availability') == 'unavailable' ? 'selected' : '' }}>Not Available
                                        </option>
                                    </select>
                                </div>
