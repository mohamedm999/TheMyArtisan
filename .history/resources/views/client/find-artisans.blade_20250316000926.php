            ...
            function fetchArtisans(page = 1) {
                ...
                fetch(`{{ route('api.artisans') }}?${params.toString()}`)
                    ...
                    .then(data => {
                        ...
                        if (!data.data) {
                            console.error('No data.data property in response:', data);
                    ...
                    .catch(error => {
                        ...
                        document.getElementById('artisans-container').innerHTML =
                            `<div class="col-span-3 text-center py-8">
                                ...
                                <p class="mt-2 text-sm text-gray-500">Please try refreshing the page or contact support.</p>
                            </div>`;
                    })
                    .finally(() => {
            ...
            function renderArtisans(artisans) {
                ...
                artisans.forEach(artisan => {
                    try {
                        ...
                        if (!artisan.user) {
                            console.warn('Artisan missing user property:', artisan);
                            return;
                        }
                        ...
                        console.error('Error rendering artisan card:', err, artisan);
                    }
                });
