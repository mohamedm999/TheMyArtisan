            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <span class="badge badge-primary">Current Balance: {{ number_format($user->points->points_balance) }} points</span>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right {{ $transaction->points > 0 ? 'text-success' : 'text-danger' }} font-weight-bold">
                    ...
                    <div class="text-center py-5">
                        <img src="{{ asset('images/no-transactions.svg') }}" alt="No Transactions" class="img-fluid mb-3" style="max-width: 150px;">
