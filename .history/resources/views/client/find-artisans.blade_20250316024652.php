        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white">
                    ...
                    <div class="mb-4 text-gray-600">
                        ...
                        @if(config('app.debug'))
                            <span class="ml-2 text-red-500">
                                (Total in DB: {{ $totalAllArtisans ?? 'N/A' }},
                                Filtered: {{ $totalFilteredArtisans ?? 'N/A' }})
                            </span>
                        @endif
                    </div>
                    ...
                    @if(config('app.debug') && isset($artisans) && $artisans->count() === 0)
                        <div class="mb-8 bg-red-50 p-4 rounded border border-red-200">
                            <h4 class="font-bold">Debug Information</h4>
                            <p>No artisans found. Possible reasons:</p>
                            <ul class="list-disc pl-5 mt-2">
                                <li>No artisan profiles exist in the database</li>
                                <li>Artisan profiles exist but don't match the filter criteria</li>
                                <li>Relationship issues between artisans and users</li>
                                <li>Insufficient permissions for the current user</li>
                            </ul>
                            <p class="mt-2">Check the Laravel logs for detailed SQL queries and error messages.</p>
                        </div>
                    @endif
