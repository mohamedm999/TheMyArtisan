                        ...
                        <div class="artisan-card bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                            <div class="relative">
                                ...
                                <div class="bg-gray-200 h-48 overflow-hidden">
                                    ...
                                    @else
                                        <div
                                            class="flex items-center justify-center h-full bg-gradient-to-r from-amber-100 to-amber-200">
                                ...
                                @if ($artisan->is_featured)
                                    <div
                                        class="absolute top-3 right-3 bg-amber-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-md">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-wrap gap-1">
                                            @foreach ($artisan->services->take(3) as $service)
                                                <span
                                                    class="tag-badge inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
                                                    {{ $service->title }}
                                                </span>
                                            @endforeach
            ...
            @else
                <div class="bg-white rounded-xl shadow-md p-10 text-center max-w-xl mx-auto">
                    ...
                    <a href="{{ route('client.artisans.index') }}"
                        class="inline-flex items-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500">
                        Clear filters
                    </a>
                </div>
            @endif
