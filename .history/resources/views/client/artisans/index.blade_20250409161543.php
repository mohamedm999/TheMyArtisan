...
@section('content')
    ...
    <div class="bg-gradient-to-r from-green-50 via-emerald-50 to-blue-50">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 text-center">
            <h1
                class="text-3xl font-extrabold text-gray-900 sm:text-4xl md:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-blue-600">
                Find Your Perfect Artisan</h1>
            <p class="mt-4 max-w-md mx-auto text-base text-gray-600 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Connect with skilled craftspeople who bring Moroccan tradition and expertise to your projects
            </p>
            <div class="mt-8 flex justify-center">
                <div class="inline-flex rounded-md shadow">
                    <a href="#search-section"
                        class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 transition-all duration-200">
    ...
    <div id="search-section" class="bg-white shadow-md sticky top-0 z-10 border-b border-gray-200">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="category" name="category"
                                    class="appearance-none mt-1 block w-full pl-3 pr-10 py-2.5 text-base border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm transition-all duration-200 hover:shadow">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select id="sort" name="sort"
                                class="mt-1 block w-full pl-3 pr-10 py-2.5 text-base border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm rounded-lg shadow-sm">
                    ...
                    <div class="flex justify-between items-center pt-2">
                        <div class="flex space-x-2 items-center">
                            @if (request('search') ||
                                ...
                                <a href="{{ route('client.artisans.index') }}"
                                    class="text-sm text-gray-600 hover:text-gray-900 flex items-center px-3 py-1.5 bg-gray-100 rounded-full hover:bg-gray-200 transition-colors duration-200">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button type="button" id="grid-view-btn"
                                class="view-toggle-btn active p-1.5 rounded-md hover:bg-gray-100 transition-colors duration-200"
                                title="Grid View">
                            ...
                            <button type="button" id="list-view-btn"
                                class="view-toggle-btn p-1.5 rounded-md hover:bg-gray-100 transition-colors duration-200"
                                title="List View">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            @if ($artisans->count() > 0)
                <div class="mb-6 flex justify-between items-center">
                    <div class="text-sm text-gray-600 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
                        Found <span class="font-semibold text-green-600">{{ $artisans->count() }}</span> artisans matching
                        your criteria
                    </div>
                </div>

                <!-- Grid View -->
                <div id="grid-view" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach ($artisans as $artisan)
                        <div
                            class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition duration-300 transform hover:-translate-y-1">
                            <a href="{{ route('client.artisans.show', $artisan->id) }}" class="block">
                                <div class="relative">
                                    ...
                                    @if ($artisan->is_featured)
                                        <div class="absolute top-3 right-3">
                                            <span
                                                class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200 shadow-sm">
                                ...
                                <div class="p-6">
                                    <div class="flex items-center justify-between mb-2">
                                        <h3
                                            class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition-colors duration-200">
                                    ...
                                    @if ($artisan->services->count() > 0)
                                        <div class="flex flex-wrap gap-1.5 mt-3">
                                            ...
                                            @if ($artisan->services->count() > 2)
                                                <span
                                                    class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-gray-50 text-gray-600 border border-gray-100">
                            ...
                            <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-between items-center">
                                <div class="text-sm font-medium text-green-600 hover:text-green-700 flex items-center">
                                    <a href="{{ route('client.artisans.show', $artisan->id) }}" class="flex items-center">
                                        View Profile
                                ...
                                <form action="{{ route('messages.start') }}" method="POST">
                                    ...
                                    <input type="hidden" name="message"
                                        value="Hello, I'm interested in your services. Are you available for a project?">
                                    <button type="submit"
                                        class="inline-flex items-center text-sm text-white bg-green-600 px-3 py-1.5 rounded-md hover:bg-green-700">
                                ...
                                <li class="hover:bg-gray-50 transition-colors duration-150">
                                    <a href="{{ route('client.artisans.show', $artisan->id) }}" class="block">
                                        <div class="px-6 py-5 sm:px-6">
                                            <div class="flex items-center">
                                                <div
                                                    class="flex-shrink-0 h-14 w-14 bg-gray-100 rounded-full overflow-hidden border border-gray-200 shadow-sm">
                                                    @if ($artisan->profile_photo)
                                                        <img src="{{ asset('storage/' . $artisan->profile_photo) }}"
                                                        ...
                                                        <div class="mt-2 flex items-center text-sm sm:mt-0">
                                                            @if ($artisan->services->count() > 0)
                                                                <div class="flex flex-wrap gap-1.5">
                                                                    ...
                                                                    @if ($artisan->services->count() > 2)
                                                                        <span
                                                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-50 text-gray-600 border border-gray-100">
                                                                            +{{ $artisan->services->count() - 2 }}
                                                                        </span>
                                                                    @endif
                                                                </div>
            ...
            @else
                <div class="bg-white rounded-xl shadow-sm p-10 text-center">
                    ...
                    <h3 class="text-2xl font-medium text-gray-900 mb-2">No artisans found</h3>
...
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add smooth scrolling to search section
            document.querySelectorAll('a[href="#search-section"]').forEach(anchor => {
