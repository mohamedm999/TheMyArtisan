                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="category" name="category"
                                class="appearance-none mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm">
