                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <button type="button" onclick="toggleServiceDetails('service-details-{{ $service->id }}')"
                        ...
                        <div id="service-details-{{ $service->id }}" class="hidden bg-gray-50 border-t border-gray-100 p-5">
                            ...
                            <div class="mt-4 grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="font-medium text-gray-900">{{ number_format($service->price, 2) }} DH</span>
                                </div>
                                @if($service->category)
                                <div>
