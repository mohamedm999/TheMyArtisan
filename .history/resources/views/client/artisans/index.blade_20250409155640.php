...
@section('content')
    ...
    <div class="bg-gradient-to-r from-green-50 via-emerald-50 to-blue-50">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-3xl font-extrabold text-gray-900 sm:text-4xl md:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-blue-600">Find Your Perfect Artisan</h1>
            ...
            <div class="mt-8 flex justify-center">
                <div class="inline-flex rounded-md shadow">
                    <a href="#search-section" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 transition-all duration-200">
                    ...
                    <div class="flex justify-between items-center pt-2">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button type="button" id="grid-view-btn"
                                class="view-toggle-btn active p-1.5 rounded-md hover:bg-gray-100 transition-colors duration-200" title="Grid View">
                            ...
                            <button type="button" id="list-view-btn"
                                class="view-toggle-btn p-1.5 rounded-md hover:bg-gray-100 transition-colors duration-200" title="List View">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @if ($artisans->count() > 0)
                <div class="mb-6 flex justify-between items-center">
                    <div class="text-sm text-gray-600 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
                        Found <span class="font-semibold text-green-600">{{ $artisans->count() }}</span> artisans matching your criteria
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <form action="{{ route('messages.start') }}" method="POST">
                                    ...
                                    <button type="submit" class="inline-flex items-center text-sm text-white bg-green-600 px-3 py-1 rounded-md hover:bg-green-700">
                                ...
                                <li class="hover:bg-gray-50 transition-colors duration-150">
                                    <a href="{{ route('client.artisans.show', $artisan->id) }}" class="block">
                                        <div class="px-6 py-5 sm:px-6">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-14 w-14 bg-gray-100 rounded-full overflow-hidden border border-gray-200 shadow-sm">
                                                    @if ($artisan->profile_photo)
                                                        <img src="{{ asset('storage/' . $artisan->profile_photo) }}"
