                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <option value="pottery" {{ request('category') == 'pottery' ? 'selected' : '' }}>Pottery</option>
                                <option value="zellige" {{ request('category') == 'zellige' ? 'selected' : '' }}>Zellige</option>
                                <option value="leather" {{ request('category') == 'leather' ? 'selected' : '' }}>Leather Craft</option>
                                <option value="carpets" {{ request('category') == 'carpets' ? 'selected' : '' }}>Carpets & Textiles</option>
                        ...
                        <div>
                            ...
                            <select id="location" name="location"
                                ...
                                <option value="essaouira" {{ request('location') == 'essaouira' ? 'selected' : '' }}>Essaouira</option>
                            </select>
                        </div>
                    ...
                    <div class="flex justify-between items-center pt-2">
                        <div class="flex space-x-2 items-center">
                            @if(request('search') || request('category') || request('location') || request('rating') || request('sort'))
                                <a href="{{ route('client.artisans.index') }}" class="text-sm text-gray-600 hover:text-gray-900 flex items-center">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button type="button" id="grid-view-btn" class="view-toggle-btn active p-1 rounded-md hover:bg-gray-100" title="Grid View">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                </svg>
                            </button>
                            <button type="button" id="list-view-btn" class="view-toggle-btn p-1 rounded-md hover:bg-gray-100" title="List View">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <a href="{{ route('client.artisans.show', $artisan->id) }}" class="block">
                                ...
                                <div class="p-5">
                                    <div class="flex items-center justify-between mb-2">
                                        <h3 class="text-lg font-semibold text-gray-900">{{ $artisan->user->firstname }} {{ $artisan->user->lastname }}</h3>
                                        ...
                                        <div class="px-4 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-12 w-12 bg-gray-100 rounded-full overflow-hidden border border-gray-200">
                                                    ...
                                                    @else
                                                        <div class="h-full w-full bg-gradient-to-r from-green-400 to-blue-500 flex items-center justify-center">
                                                            <span class="text-lg font-bold text-white">{{ substr($artisan->user->firstname, 0, 1) }}</span>
                                                        </div>
                                                    @endif
                                                </div>
                                                            ...
                                                            <h3 class="text-base font-medium text-gray-900 flex items-center">
                                                                ...
                                                                @if ($artisan->is_featured)
                                                                    <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                                        <svg class="mr-0.5 h-2 w-2 text-green-500" fill="currentColor" viewBox="0 0 8 8">
                                                                            <circle cx="4" cy="4" r="3" />
                                                                        </svg>
                                                                        Featured
                                                                    </span>
            ...
            @else
                <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                    ...
                    <p class="mt-2 text-gray-500 max-w-md mx-auto">Try adjusting your search criteria or check back later as new artisans join our platform.</p>
                    <div class="mt-6">
