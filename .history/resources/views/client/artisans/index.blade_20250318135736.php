...
@section('content')
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(isset($artisans))
                <div class="bg-blue-100 p-2 mb-4 rounded">
                    <p class="text-blue-800 text-sm">Debug: {{ $artisans->count() }} artisans found</p>
                </div>
            @else
                <div class="bg-red-100 p-2 mb-4 rounded">
                    <p class="text-red-800 text-sm">Debug: $artisans variable is not set</p>
                </div>
            @endif
                ...
                <div class="bg-white p-12 rounded-lg shadow text-center">
                    ...
                    <p class="text-gray-500">
                        @if(request('search') || request('category'))
                            No artisans match your current search criteria. Try adjusting your search filters or explore different categories.
                        @else
