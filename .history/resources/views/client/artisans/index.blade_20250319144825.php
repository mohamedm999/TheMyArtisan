                ...
                <div class="card h-100 shadow-sm artisan-card">
                    <div class="profile-img-container text-center">
                        <img src="{{ $artisan->profile_photo ? asset('storage/'.$artisan->profile_photo) : asset('images/default-profile.jpg') }}"
                            class="rounded-circle profile-img" alt="{{ $artisan->user->name }}" width="120" height="120">
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer bg-white border-0 text-center py-3">
                        <a href="{{ route('client.artisans.show', $artisan->id) }}" class="btn btn-primary view-profile-btn">View Profile</a>
                    </div>
                </div>
            </div>
        @empty
