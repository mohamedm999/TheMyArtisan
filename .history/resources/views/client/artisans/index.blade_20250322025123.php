...
@section('content')
    ...
    <div class="bg-white shadow-sm sticky top-0 z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <form id="artisan-filter-form" action="{{ route('client.artisans.index') }}" method="GET">
                <div class="space-y-4">
    ...
    <div class="bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="search-results">
            @if ($artisans->count() > 0)
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('artisan-filter-form');
            ...
            loadingIndicator.className = 'fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50';
            loadingIndicator.style.display = 'none';
            loadingIndicator.innerHTML = `
                <div class="bg-white p-5 rounded-lg shadow-lg flex items-center">
                    <svg class="animate-spin h-6 w-6 text-green-600 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <span class="text-gray-700 font-medium">Loading results...</span>
                </div>
            `;
            ...
            function performSearch(e) {
                ...
                .then(html => {
                    ...
                    if (newGridView && newListView) {
                        if (localStorage.getItem('preferredView') === 'list') {
            ...
            countrySelect.addEventListener('change', function() {
                ...
                // Don't trigger search here as the country's onChange will already trigger it
            });
        });
    </script>
@endsection
