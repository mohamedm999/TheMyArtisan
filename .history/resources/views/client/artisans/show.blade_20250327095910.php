...
@section('content')
    ...
    <div class="bg-gradient-to-r from-green-50 via-emerald-50 to-blue-50 relative py-16">
        @if ($artisan->speciality)
            <div
                class="specialty-badge px-4 py-1.5 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-full shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:flex lg:items-center lg:justify-between">
                    ...
                    <div class="flex items-center">
                        @if ($artisan->profile_photo)
                            <img src="{{ asset('storage/' . $artisan->profile_photo) }}"
                                ...
                                class="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-white shadow-xl">
                        @else
                            <div
                                class="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-r from-green-400 to-blue-500 rounded-full flex justify-center items-center border-4 border-white shadow-xl">
                                <span
                                    class="text-4xl font-bold text-white">{{ substr($artisan->user->firstname, 0, 1) }}</span>
                            </div>
                        @endif
                        <div class="ml-6">
                            <h1 class="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">{{ $artisan->user->firstname }}</h1>
                            <p class="text-sm md:text-base text-gray-600 mt-1">{{ implode(', ', $artisan->skills ?? []) }}</p>
                            ...
                            <div class="flex items-center mt-3">
                                ...
                                <span class="text-sm md:text-base text-gray-600 ml-2 font-medium">
                                    {{ number_format($artisan->average_rating, 1) }}
                                    <span class="text-gray-500 font-normal">({{ $artisan->reviews_count }} reviews)</span>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-5">
                            <div class="flex flex-wrap gap-2">
                                @foreach ($artisan->skills as $skill)
                                    <span
                                        class="skill-tag inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 shadow-sm border border-green-200">
                                        {{ $skill }}
                                    </span>
                                @endforeach
                            </div>
                ...
                <div class="mt-6 flex lg:mt-0 lg:ml-4 flex-col sm:flex-row gap-3">
                    <a href="#contact"
                        class="sm:inline-flex sm:items-center px-5 py-2.5 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                    ...
                    <a href="#" onclick="switchTab(event, 'services')"
                        class="sm:inline-flex sm:items-center px-5 py-2.5 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    @auth
                        ...
                        @if ($isSaved)
                            <form action="{{ route('client.unsave-artisan', $artisan->id) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="sm:inline-flex sm:items-center px-5 py-2.5 border border-transparent text-base font-medium rounded-lg text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200">
                        ...
                        @else
                            <form action="{{ route('client.save-artisan', $artisan->id) }}" method="POST"
                                ...
                                @csrf
                                <button type="submit"
                                    class="sm:inline-flex sm:items-center px-5 py-2.5 border border-red-300 text-base font-medium rounded-lg text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex overflow-x-auto py-3 space-x-8">
                <button onclick="switchTab(event, 'about')"
                    class="tab-btn active whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">About</button>
                <button onclick="switchTab(event, 'services')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Services</button>
                <button onclick="switchTab(event, 'experience')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Experience</button>
                <button onclick="switchTab(event, 'certifications')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Certifications</button>
                <button onclick="switchTab(event, 'availability')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Availability</button>
                <button onclick="switchTab(event, 'reviews')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Reviews</button>
                <button onclick="switchTab(event, 'book')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Book Now</button>
                <button onclick="switchTab(event, 'contact')"
                    class="tab-btn whitespace-nowrap py-2 px-1 text-gray-500 hover:text-gray-900 transition-colors duration-200">Contact</button>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div id="about" class="tab-content active">
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                <div class="px-6 py-6">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4">About {{ $artisan->user->firstname }}</h2>
        ...
        <div id="services" class="tab-content">
            <div class="mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">Services Offered</h2>
            ...
            @if ($artisan->services->pluck('category_id')->unique()->count() > 1)
                <div class="mb-6">
                    <div class="flex flex-wrap gap-2">
                        <button
                            class="service-category-filter active px-3 py-1.5 rounded-full text-sm bg-green-600 text-white shadow-sm transition-all duration-200"
                            data-category="all">
                            All
                        </button>
                        @foreach ($artisan->services->pluck('category.name', 'category_id')->unique() as $id => $name)
                            @if ($name)
                                <button
                                    class="service-category-filter px-3 py-1.5 rounded-full text-sm bg-gray-200 hover:bg-gray-300 text-gray-700 shadow-sm transition-all duration-200"
                                    data-category="{{ $id }}">
                                    {{ $name }}
                                </button>
                            @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($artisan->services as $service)
                    <div class="service-card bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100
                                transition transform hover:-translate-y-1 hover:shadow-md duration-300"
                        ...
                        @else
                            <div
                                class="w-full h-40 bg-gradient-to-r from-green-200 to-blue-200 flex items-center justify-center">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <span class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-md">{{ $service->duration }} min</span>
                                <button type="button"
                                    onclick="toggleServiceDetails('service-details-{{ $service->id }}')"
                                    class="inline-flex items-center px-3 py-1.5 text-sm bg-white border border-green-600 text-green-600 rounded-md hover:bg-green-50 transition-colors duration-200">
                                    View Details
                        ...
                        <div id="service-details-{{ $service->id }}"
                            class="hidden bg-gray-50 border-t border-gray-100 p-6">
                            ...
                            <div class="mt-6 flex justify-end">
                                <button type="button"
                                    onclick="toggleServiceDetails('service-details-{{ $service->id }}')"
                                    class="text-sm text-gray-600 hover:text-gray-900 inline-flex items-center transition-colors duration-200">
                ...
                @empty
                    <div class="col-span-full bg-gray-50 rounded-xl p-8 text-center">
                        ...
                        <p class="mt-4 text-gray-600 font-medium">This artisan has not listed any services yet.</p>
                        <p class="text-gray-500 mt-2">Check back later or contact them directly for more information.</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div id="experience" class="tab-content">
            ...
            <div class="space-y-6">
                @forelse($artisan->workExperiences as $experience)
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden border-l-4 border-green-500 pl-0 pr-6">
                        <div class="p-6">
                ...
                @empty
                    <div class="bg-gray-50 rounded-xl p-8 text-center">
                        ...
                        <p class="mt-4 text-gray-600 font-medium">No work experience listed.</p>
                        <p class="text-gray-500 mt-2">This artisan hasn't added their work history yet.</p>
                    </div>
                @endforelse
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="ml-4">
                                    ...
                                    @if ($certification->credential_url)
                                        <a href="{{ $certification->credential_url }}" target="_blank"
                                            class="mt-3 inline-flex items-center text-sm text-blue-600 hover:text-blue-800 transition-colors duration-200">
                ...
                @empty
                    <div class="col-span-full bg-gray-50 rounded-xl p-8 text-center">
                        ...
                        <p class="mt-4 text-gray-600 font-medium">No certifications listed.</p>
                        <p class="text-gray-500 mt-2">This artisan hasn't added any certifications or credentials yet.</p>
                    </div>
                @endforelse
            </div>
        </div>
                ...
                <div class="p-6">
                    @if (count($artisan->availabilities) > 0)
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach ($artisan->availabilities->sortBy('date')->take(6) as $availability)
                                <div
                                    class="bg-white rounded-lg border {{ $availability->status === 'booked' ? 'border-red-200 bg-red-50' : 'border-green-200 bg-green-50' }} p-4 shadow-sm">
                                    ...
                                    <div
                                        class="mt-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $availability->status === 'booked' ? 'bg-red-100 text-red-800 border border-red-200' : 'bg-green-100 text-green-800 border border-green-200' }}">
                    ...
                    @else
                        <div class="text-center p-8">
                            ...
                            <p class="mt-4 text-gray-600 font-medium">No availability information provided.</p>
                            <p class="text-gray-500 mt-2">Contact the artisan directly to inquire about their schedule.</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow duration-300">
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-4">
                                <div class="flex items-center">
                                    <div
                                        class="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-green-100 to-blue-100 rounded-full flex items-center justify-center border border-gray-200">
                                        <span
                                            class="text-gray-700 font-medium text-lg">{{ substr($review->user->firstname ?? 'A', 0, 1) }}</span>
                                    </div>
                                    <div class="ml-4">
                ...
                @empty
                    <div class="bg-gray-50 rounded-xl p-8 text-center">
                        ...
                        <p class="mt-4 text-gray-600 font-medium">No reviews yet. Be the first to leave a review!</p>
                        <p class="text-gray-500 mt-2">Share your experience working with this artisan.</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div id="contact" class="tab-content">
            <div class="mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">Contact {{ $artisan->user->firstname }}</h2>
                    ...
                    <form action="{{ route('client.contact') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="subject" id="subject" required
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-lg @error('subject') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror">
                                @error('subject')
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="tel" name="phone" id="phone"
                                        class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-lg @error('phone') border-red-300 @enderror">
                                    @error('phone')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <select id="preferred_contact" name="preferred_contact"
                                        class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="message" name="message" rows="4" required
                                    class="shadow-sm focus:ring-green-500 focus:border-green-500 block w-full sm:text-sm border-gray-300 rounded-lg @error('message') border-red-300 @enderror"></textarea>
                                @error('message')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="{{ route('client.artisans.index') }}"
                                class="inline-flex items-center px-5 py-2.5 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                                <svg class="mr-2 -ml-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
        ...
        <div id="book" class="tab-content">
            <div class="mb-6">
                <h2 class="text-2xl font-semibold text-gray-800">Book {{ $artisan->user->firstname }}'s Services</h2>
                ...
                <div class="p-6">
                    ...
                    @auth
                        @if (Auth::user()->clientProfile)
                            <form action="{{ route('client.bookings.store') }}" method="POST" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select id="service_id" name="service_id" required
                                            class="mt-1 block w-full pl-3 pr-10 py-2.5 text-base border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm rounded-lg">
                                ...
                                <!-- Service Summary -->
                                <div id="service-summary" class="hidden bg-gray-50 p-4 rounded-lg border border-gray-200">
                                ...
                                <div>
                                    <button type="submit"
                                        class="w-full inline-flex items-center justify-center px-5 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <h3 class="mt-2 text-lg font-medium text-gray-900">Complete your profile first</h3>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-lg font-medium text-gray-900">Login to book services</h3>
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                if (isUnsave) {
                                    ...
                                    this.innerHTML = `
                                    @csrf
                                    <button type="submit" class="sm:inline-flex sm:items-center px-5 py-2.5 border border-red-300 text-base font-medium rounded-lg text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                `;
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="sm:inline-flex sm:items-center px-5 py-2.5 border border-transparent text-base font-medium rounded-lg text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200">
