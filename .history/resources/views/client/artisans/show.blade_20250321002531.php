                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="p-4">
                            ...
                            @if($certification->valid_until)
                                <p class="text-sm text-gray-500 mb-2">Valid until: {{ $certification->valid_until->format('M Y') }}</p>
                            @endif
                    ...
                    @if(count($artisan->availabilities ?? []) > 0)
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($artisan->availabilities->sortBy('date')->take(6) as $availability)
                                <div class="border border-gray-200 rounded-md p-3 {{ $availability->status === 'booked' ? 'bg-gray-100' : 'bg-green-50' }}">
                                    ...
                                    <div class="mt-1 text-xs {{ $availability->status === 'booked' ? 'text-red-600' : 'text-green-600' }}">
