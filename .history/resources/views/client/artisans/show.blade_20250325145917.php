        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <!-- Add this where you want the save button to appear -->
                    <div class="mt-4 flex items-center">
                        @php
                            $isSaved = false;
                            if (auth()->check()) {
                                $isSaved = \App\Models\SavedArtisan::where('user_id', auth()->id())
                        ...
                        @if($isSaved)
                            <form action="{{ route('client.unsave-artisan', $artisan->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="flex items-center px-4 py-2 rounded-md bg-red-50 text-red-600 hover:bg-red-100 transition-colors">
                        ...
                        @else
                            <form action="{{ route('client.save-artisan', $artisan->id) }}" method="POST">
                                @csrf
                                <button type="submit" class="flex items-center px-4 py-2 rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors">
