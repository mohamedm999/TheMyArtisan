        ...
        <div class="col-md-3">
            <div class="text-center mb-3">
                @if($artisan->profile_photo)
                    <img src="{{ asset('storage/' . $artisan->profile_photo) }}" alt="{{ $artisan->name }}" class="img-fluid rounded-circle" style="width: 200px; height: 200px; object-fit: cover;">
                @else
                    <div class="bg-secondary rounded-circle d-flex justify-content-center align-items-center" style="width: 200px; height: 200px; margin: 0 auto;">
        ...
        <div class="col-md-9">
            ...
            <div class="d-flex align-items-center mb-3">
                <div class="ratings me-2">
                    @for($i = 1; $i <= 5; $i++)
                        <i class="bi bi-star{{ $i <= $artisan->average_rating ? '-fill' : ($i - 0.5 <= $artisan->average_rating ? '-half' : '') }} text-warning"></i>
                    @endfor
                </div>
            ...
            <p class="mb-2"><i class="bi bi-calendar-check"></i> Member since {{ $artisan->created_at->format('M Y') }}</p>
            <div class="mt-4">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-primary fw-bold">{{ number_format($service->price, 2) }} DH</p>
                                <a href="{{ route('client.services.show', $service->id) }}" class="btn btn-sm btn-outline-primary">View Details</a>
                            </div>
                        </div>
                    </div>
                @empty
