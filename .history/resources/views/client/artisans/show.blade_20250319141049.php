                ...
                <div class="row">
                    <div class="col-md-3 text-center">
                        <img src="{{ $artisan->profile_photo ? asset('storage/' . $artisan->profile_photo) : asset('images/default-profile.jpg') }}"
                            class="rounded-circle img-fluid mb-3" alt="{{ $artisan->user->name }}"
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        @forelse($artisan->services as $service)
                            <div
                                class="d-flex justify-content-between align-items-start mb-4 {{ !$loop->last ? 'pb-4 border-bottom' : '' }}">
                                <div>
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="{{ route('client.bookings.create', ['service' => $service->id]) }}"
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $review->client->user->profile_photo ? asset('storage/' . $review->client->user->profile_photo) : asset('images/default-profile.jpg') }}"
                                            class="rounded-circle me-2" alt="{{ $review->client->user->name }}"
                                            width="40">
                                        <div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between px-0">
                                        ...
                                        <span>
                                            @if (isset($artisan->availability[$day]) && $artisan->availability[$day]['available'])
                                                {{ $artisan->availability[$day]['start_time'] }} -
                                                {{ $artisan->availability[$day]['end_time'] }}
                                            @else
                        ...
                        <div class="mt-3">
                            <a href="{{ route('client.bookings.create', ['artisan' => $artisan->id]) }}"
