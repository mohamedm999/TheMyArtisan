...
<style>
    /* Fix any potential conflicts with Tailwind */
    .card {
        position: relative;
        display: flex;
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('client.contact') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="schedule_date" class="form-label">Schedule a Meeting (optional)</label>
                                <input type="datetime-local"
                                    class="form-control @error('schedule_date') is-invalid @enderror" id="schedule_date"
                                    name="schedule_date">
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex">
                                ...
                                <a href="{{ route('client.artisans.index') }}" class="btn btn-outline-secondary">
                                    <i class="bi bi-arrow-left me-1"></i> Back to Artisans
                                </a>
                            </div>
                        </form>
                    </div>
