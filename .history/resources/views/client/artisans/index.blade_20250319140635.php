<!-- filepath: c:\wamp64\www\MyArtisan-platform\resources\views\client\artisans\index.blade.php -->
@extends('layouts.client')

@section('content')
<div class="container py-5">
    <h1 class="mb-4">Find an Artisan</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <span class="small">{{ $artisan->city }}, {{ $artisan->state }}</span>
                            </div>
                            <div>
                                <i class="fas fa-briefcase text-secondary"></i>
                                <span class="small">{{ $artisan->years_experience }} years exp.</span>
                            </div>
                        </div>
                    </div>
