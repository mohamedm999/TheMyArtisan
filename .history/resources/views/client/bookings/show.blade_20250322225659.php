...
@section('content')
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            <!-- Back button -->
            <div class="mb-6">
                <a href="{{ route('client.bookings.index') }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="bg-gray-50 px-4 py-4 sm:px-6 border-t border-gray-200">
                    <div class="flex justify-end space-x-3">
                        ...
                        <a href="{{ route('client.artisans.show', $booking->artisanProfile->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">
