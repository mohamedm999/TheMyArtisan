...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::prefix('store')->name('store.')->group(function () {
        ...
        Route::put('/orders/{id}/status', [\App\Http\Controllers\Admin\StoreOrderController::class, 'updateStatus'])->name('orders.update-status');
        Route::post('/orders/{id}/update-admin-notes', [\App\Http\Controllers\Admin\StoreOrderController::class, 'updateAdminNotes'])->name('orders.update-admin-notes');
        Route::post('/orders/{id}/cancel', [\App\Http\Controllers\Admin\StoreOrderController::class, 'cancelOrder'])->name('orders.cancel');
        Route::post('/orders/{id}/complete', [\App\Http\Controllers\Admin\StoreOrderController::class, 'completeOrder'])->name('orders.complete');
        Route::get('/orders/{id}/email', [\App\Http\Controllers\Admin\StoreOrderController::class, 'showEmailForm'])->name('orders.email');
        Route::post('/orders/{id}/send-email', [\App\Http\Controllers\Admin\StoreOrderController::class, 'sendEmail'])->name('orders.send-email');
    });
...
Route::prefix('client')->name('client.')->middleware(['auth', 'role:client'])->group(function () {
    ...
    Route::get('/store/featured', [\App\Http\Controllers\Client\StoreController::class, 'featured'])->name('store.featured');
