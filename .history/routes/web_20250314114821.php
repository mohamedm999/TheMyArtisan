...
Route::prefix('client')->middleware(['auth', 'role:client'])->group(function () {
    ...
    Route::get('/profile', [App\Http\Controllers\Client\ClientProfileController::class, 'index'])->name('client.profile');
    Route::post('/profile', [App\Http\Controllers\Client\ClientProfileController::class, 'update'])->name('client.profile.update');
    Route::post('/profile/photo', [App\Http\Controllers\Client\ClientProfileController::class, 'updatePhoto'])->name('client.profile.photo');
