...
Route::middleware(['auth', 'role:client'])->group(function () {
    Route::get('/artisans', [App\Http\Controllers\Client\ArtisanController::class, 'index'])->name('client.artisans.index');
    Route::get('/artisans/{id}', [App\Http\Controllers\Client\ArtisanController::class, 'show'])->name('client.artisans.show');
});
