...
use App\Http\Controllers\Client\FindArtisansController;
...
Route::prefix('client')->name('client.')->middleware(['auth', 'role:client'])->group(function () {
    ...
    // Updated route for find-artisans
    Route::get('/find-artisans', [FindArtisansController::class, 'index'])->name('find-artisans');
    Route::post('/find-artisans/search', [FindArtisansController::class, 'search'])->name('find-artisans.search');
