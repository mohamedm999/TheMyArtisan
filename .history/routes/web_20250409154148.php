...
Route::middleware(['auth'])->group(function () {
    ...
    // Add client-specific named routes that point to the same controller methods
    Route::get('/client/messages', [App\Http\Controllers\MessageController::class, 'index'])->name('client.messages');
    Route::get('/client/messages/{conversation}', [App\Http\Controllers\MessageController::class, 'show'])->name('client.message.show');

    // Add artisan-specific named routes that point to the same controller methods
    Route::get('/artisan/messages', [App\Http\Controllers\MessageController::class, 'index'])->name('artisan.messages');
    Route::get('/artisan/messages/{conversation}', [App\Http\Controllers\MessageController::class, 'show'])->name('artisan.message.show');
});
