...
Route::prefix('client')->name('client.')->middleware(['auth', 'role:client'])->group(function () {
    ...
    // Add an alias route (find-artisans) that points to the same controller action as artisans.index
    Route::get('/find-artisans', [App\Http\Controllers\Client\ArtisanController::class, 'index'])->name('find-artisans');
});
