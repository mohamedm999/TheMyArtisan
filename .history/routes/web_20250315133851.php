...
// Client routes for finding artisans
Route::get('/find-artisans', [App\Http\Controllers\Client\FindArtisanController::class, 'index'])
    ->name('client.find-artisans');
Route::get('/artisans/{id}', [App\Http\Controllers\Client\FindArtisanController::class, 'show'])
    ->name('client.artisan-profile');
Route::post('/artisans/{id}/save', [App\Http\Controllers\Client\FindArtisanController::class, 'saveArtisan'])
