...
<?php
// Add this temporary debugging route to your web.php file
Route::get('/debug/check-admin/{userId}', function ($userId) {
    $user = \App\Models\User::find($userId);
    if (!$user) return 'User not found';

    $roleRecords = \Illuminate\Support\Facades\DB::table('role_user')
    ...
    return [
        ...
        'roles_relationship' => $roleRecords,
        'all_available_roles' => $roles,
        'admin_check_result' => $user->hasRole('admin')
    ];
})->middleware('auth');
