...
Route::prefix('artisan')->name('artisan.')->middleware(['auth', 'role:artisan'])->group(function () {
    ...
    Route::post('/reviews/{id}/respond', [App\Http\Controllers\Artisan\ReviewController::class, 'respond'])->name('reviews.respond');
    Route::post('/reviews/{id}/report', [App\Http\Controllers\Artisan\ReviewController::class, 'report'])->name('reviews.report');
