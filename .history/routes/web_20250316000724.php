...
// Debug route to test artisans API directly
Route::get('/debug/artisans', function() {
    $artisanProfiles = \App\Models\ArtisanProfile::with(['user', 'category'])->limit(5)->get();
    return response()->json([
        'success' => true,
        'count' => $artisanProfiles->count(),
