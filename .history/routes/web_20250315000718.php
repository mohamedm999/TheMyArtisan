...
Route::prefix('client')->name('client.')->middleware(['auth', 'role:client'])->group(function () {
    ...
    Route::get('/find-artisans', [ClientDashboardController::class, 'findArtisans'])->name('find-artisans');
...
// Client Find Artisans Routes
Route::prefix('client')->middleware(['auth', 'role:client'])->group(function () {
    Route::get('/find-artisans', [App\Http\Controllers\Client\FindArtisansController::class, 'index'])->name('client.find-artisans');
    Route::get('/find-artisans/search', [App\Http\Controllers\Client\FindArtisansController::class, 'search'])->name('client.find-artisans.search');
    Route::get('/find-artisans/{id}', [App\Http\Controllers\Client\FindArtisansController::class, 'viewArtisan'])->name('client.find-artisans.view');
    Route::get('/find-artisans/history', [App\Http\Controllers\Client\FindArtisansController::class, 'searchHistory'])->name('client.find-artisans.history');
});
