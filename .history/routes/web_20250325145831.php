...
Route::prefix('client')->name('client.')->middleware(['auth', 'role:client'])->group(function () {
    ...
    // Add these new routes for saving/unsaving artisans
    Route::post('/artisans/{id}/save', [App\Http\Controllers\Client\ArtisanController::class, 'saveArtisan'])
        ->name('save-artisan');
    Route::delete('/artisans/{id}/unsave', [App\Http\Controllers\Client\ArtisanController::class, 'unsaveArtisan'])
        ->name('unsave-artisan');
});
