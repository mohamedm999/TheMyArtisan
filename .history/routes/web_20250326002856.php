...
Route::middleware(['auth', 'verified', 'role:client'])->prefix('client')->name('client.')->group(function () {
    ...
    Route::get('/bookings/{booking}/review', [App\Http\Controllers\Client\ReviewController::class, 'create'])->name('reviews.create');
    Route::post('/bookings/{booking}/review', [App\Http\Controllers\Client\ReviewController::class, 'store'])->name('reviews.store');
});
...
// Client saved artisans routes
Route::middleware(['auth', 'role:client'])->prefix('client')->name('client.')->group(function () {
    // Existing route is already connected to this view
    // Route::get('/saved-artisans', [ClientDashboardController::class, 'savedArtisans'])->name('saved-artisans');

    // Add these new routes:
    Route::post('/artisans/{id}/save', [App\Http\Controllers\Client\SavedArtisanController::class, 'store'])->name('save-artisan');
    Route::delete('/artisans/{id}/unsave', [App\Http\Controllers\Client\SavedArtisanController::class, 'destroy'])->name('unsave-artisan');
});

// Saved Artisan routes
Route::middleware(['auth', 'role:client'])->group(function () {
    Route::get('/saved-artisans', [SavedArtisanController::class, 'index'])->name('client.saved-artisans');
    Route::post('/artisans/{artisan}/save', [SavedArtisanController::class, 'saveArtisan'])->name('client.save-artisan');
    Route::delete('/artisans/{artisan}/unsave', [SavedArtisanController::class, 'unsaveArtisan'])->name('client.unsave-artisan');
});
