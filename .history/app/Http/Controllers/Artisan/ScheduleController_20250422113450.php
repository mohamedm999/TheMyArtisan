...
class ScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get availabilities without grouping first - Using only artisan_profile_id
        if ($artisanProfileId) {
            $availabilities = Availability::where('artisan_profile_id', $artisanProfileId)
                ->whereBetween('date', [
            ...
            $availabilities = collect(); // Empty collection if no profile
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Check for overlapping availabilities using artisan_profile_id column
            $overlapping = Availability::where('artisan_profile_id', $artisanProfileId)
            ...
            if ($request->repeat === 'weekly') {
                ...
                while ($currentDate <= $repeatUntil) {
                    Availability::create([
                        'artisan_profile_id' => $artisanProfileId, // Using correct column name
    ...
    public function destroy($id)
    {
        ...
        $availability = Availability::where('id', $id)
            ->where('artisan_profile_id', $artisanProfileId) // Using correct column name
            ->first();
