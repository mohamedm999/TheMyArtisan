...
class ArtisanProfileController extends Controller
{
    ...
    public function addWorkExperience(Request $request)
    {
        try {
            ...
            // Create work experience - using the correct column names from the database
            $workExp = new WorkExperience();
            $workExp->artisan_profile_id = $artisanProfile->id;
            $workExp->user_id = $user->id;  // Set the user_id field that exists in the database
            $workExp->position = $request->title;  // Map 'title' field to 'position' column
            $workExp->company_name = $request->company;  // Map 'company' field to 'company_name' column
