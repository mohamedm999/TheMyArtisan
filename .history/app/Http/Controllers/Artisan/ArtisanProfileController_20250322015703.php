...
class ArtisanProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('artisan.profile', compact('artisanProfile', 'workExperiences', 'certifications', 'categories', 'selectedCategories', 'locations'));
    }
    ...
    public function updateContactInfo(Request $request)
    {
        ...
        $artisanProfile->location_id = $request->location_id;
        $artisanProfile->save();
