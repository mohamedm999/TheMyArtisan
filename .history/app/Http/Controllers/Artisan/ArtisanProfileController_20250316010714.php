...
class ArtisanProfileController extends Controller
{
    ...
    public function addWorkExperience(Request $request)
    {
        try {
            ...
            $workExp->title = $request->position;
            $workExp->company = $request->company_name;
            ...
            Log::info("Work experience created successfully for artisan {$artisanProfile->id}");
    ...
    public function addCertification(Request $request)
    {
        try {
            ...
            $certification->title = $request->name;
            $certification->issuing_organization = $request->issuer;
            $certification->issue_date = now();
            $certification->expiry_date = $request->valid_until;
            $certification->save();

            Log::info("Certification created successfully for artisan {$artisanProfile->id}");
