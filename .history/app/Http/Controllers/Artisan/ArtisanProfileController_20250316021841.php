...
class ArtisanProfileController extends Controller
{
    ...
    public function addWorkExperience(Request $request)
    {
        try {
            ...
            // Count existing work experiences for this user
            $existingCount = WorkExperience::where('artisan_profile_id', $artisanProfile->id)->count();
            Log::info("User already has {$existingCount} work experiences");
            ...
            $workExp->company_name = $request->company ?? '';  // Ensure not null
            ...
            $workExp->description = $request->description ?? '';  // Ensure not null
