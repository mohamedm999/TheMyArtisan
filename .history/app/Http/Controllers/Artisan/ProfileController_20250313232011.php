...
class ProfileController extends Controller
{
    ...
    public function storeWorkExperience(Request $request)
    {
        ...
        // Create work experience with field mapping from form to database
        WorkExperience::create([
            'user_id' => $user->id,
            'position' => $request->title,         // Map title -> position
            'company_name' => $request->company,   // Map company -> company_name
    ...
    public function storeCertification(Request $request)
    {
        ...
        // Implement certification storage based on your model structure
