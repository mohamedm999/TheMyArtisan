...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Get service details for the success message
        $service = Service::findOrFail($request->service_id);
        $artisan = ArtisanProfile::with('user')->findOrFail($request->artisan_profile_id);
        ...
        return redirect()->route('client.bookings.index')
            ->with('success', "Your booking for '{$service->name}' with {$artisan->user->firstname} has been submitted and is pending confirmation.");
    }
