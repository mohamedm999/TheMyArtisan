...
class ArtisanController extends Controller
{
    public function index()
    {
        ...
        })->with('artisanProfile')->paginate(10);
    ...
    public function show($id)
    {
        $artisan = User::whereHas('roles', function ($query) {
            $query->where('name', 'artisan');
        })->with(['artisanProfile', 'services', 'bookings'])->findOrFail($id);
    ...
    /**
     * Display artisans and their relationships.
     *
    ...
    public function relationships()
    {
        ...
        return view('admin.artisans.relationships', compact('artisans'));
    }
}
