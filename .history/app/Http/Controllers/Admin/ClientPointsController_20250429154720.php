...
class ClientPointsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.client-points.index', compact('clients', 'stats'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.client-points.show', compact('user', 'clientPoints', 'transactions'));
    }
    ...
    public function analytics()
    {
        ...
        return view('admin.client-points.analytics', compact('analytics'));
    }
}
