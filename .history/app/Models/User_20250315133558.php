...
class User extends Authenticatable
{
    ...
    /**
     * Get the bookings made by the client.
     */
    ...
    /**
     * Get the reviews associated with the artisan.
     */
    ...
    /**
     * Get the artisans that the user has favorited.
     */
    public function favoriteArtisans()
    {
        return $this->belongsToMany(User::class, 'favorites', 'user_id', 'artisan_id');
    }
