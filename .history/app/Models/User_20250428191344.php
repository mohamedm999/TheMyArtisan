...
class User extends Authenticatable
{
    ...
    /**
     * Get the client's points. Renamed from points() to match diagram.
     */
    ...
    /**
     * Get all bookings made by the user (as a client). Added based on diagram.
     */
    public function bookings()
    {
        // Assuming bookings are primarily made via ClientProfile
        return $this->hasManyThrough(Booking::class, ClientProfile::class, 'user_id', 'client_profile_id', 'id', 'id');
        // If artisans can also book, logic might need adjustment or separate methods.
    }

    /**
     * Get all reviews written by the user (as a client). Added based on diagram.
     */
    public function reviews()
    {
        // Assuming reviews are primarily written via ClientProfile
        return $this->hasManyThrough(Review::class, ClientProfile::class, 'user_id', 'client_profile_id', 'id', 'id');
        // If artisans can also review, logic might need adjustment or separate methods.
    }
    ...
    {
        return $this->clientPoint ? $this->clientPoint->points_balance : 0;
    }
