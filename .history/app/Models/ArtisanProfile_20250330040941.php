...
class ArtisanProfile extends Model
{
    ...
    protected $fillable = [
        ...
        'city_id',
        'country_id',
        'speciality', // Add this field - note the spelling "speciality" (not "specialty")
        'specialty',  // Add this field as well in case it's named this way in some places
        'status',     // Add status field to fillable
    ];
