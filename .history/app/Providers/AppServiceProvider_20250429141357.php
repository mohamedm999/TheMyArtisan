...
use App\Repositories\AdminArtisanRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        // Register Admin Artisan Repository
        $this->app->bind(AdminArtisanRepositoryInterface::class, AdminArtisanRepository::class);
    }
